...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-keyvault/azure-cli-keyvault-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-keyvault-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-keyvault-%{version}

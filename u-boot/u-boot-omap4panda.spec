...
%define is_rpi 1
%endif
%if "omap4panda" == "evb-rk3399" || "omap4panda" == "firefly-rk3399" || "omap4panda" == "puma-rk3399" || "omap4panda" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "omap4panda" == "bananapim64" || "omap4panda" == "nanopia64" || "omap4panda" == "pine64plus" || "omap4panda" == "pinebook"
%define is_a64 1
%endif
%if "omap4panda" == "orangepipc2"
%define is_h5 1
%endif
%if "omap4panda" == "pineh64"
%define is_h6 1
%endif
...
This package contains the firmware for the omap4panda platform.

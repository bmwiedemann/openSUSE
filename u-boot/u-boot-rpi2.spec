...
%if %x_loader == 1
Obsoletes:      x-loader-rpi2
Provides:       x-loader-rpi2
%endif
...
This package contains the firmware for the rpi2 platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" rpi_2_defconfig

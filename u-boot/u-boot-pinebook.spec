#
# spec file for package u-boot-pinebook
#
...
%if "pinebook" == "rpi" || "pinebook" == "rpi2" || "pinebook" == "rpi3"
%define is_rpi 1
%endif
%if "pinebook" == "evb-rk3399" || "pinebook" == "firefly-rk3399" || "pinebook" == "puma-rk3399" || "pinebook" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "pinebook" == "bananapim64" || "pinebook" == "nanopia64" || "pinebook" == "pine64plus" || "pinebook" == "pinebook"
%define is_a64 1
%endif
%if "pinebook" == "orangepipc2"
%define is_h5 1
%endif
%if "pinebook" == "pineh64"
%define is_h6 1
...
%if %x_loader == 1
Obsoletes:      x-loader-pinebook
Provides:       x-loader-pinebook
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" pinebook_defconfig

...
%if "xilinxzynqmpgeneric" == "rpi" || "xilinxzynqmpgeneric" == "rpi2" || "xilinxzynqmpgeneric" == "rpi3"
%define is_rpi 1
%endif
%if "xilinxzynqmpgeneric" == "evb-rk3399" || "xilinxzynqmpgeneric" == "firefly-rk3399" || "xilinxzynqmpgeneric" == "puma-rk3399" || "xilinxzynqmpgeneric" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "xilinxzynqmpgeneric" == "bananapim64" || "xilinxzynqmpgeneric" == "nanopia64" || "xilinxzynqmpgeneric" == "pine64plus" || "xilinxzynqmpgeneric" == "pinebook"
%define is_a64 1
%endif
%if "xilinxzynqmpgeneric" == "orangepipc2"
%define is_h5 1
%endif
%if "xilinxzynqmpgeneric" == "pineh64"
%define is_h6 1
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" xilinx_zynqmp_generic_defconfig
...
if mountpoint -q /boot/efi; then
  if ! [[ "$(readlink -f /boot/efi)" -ef "$(readlink -f %{uboot_dir})" ]]; then
    ...
    cp %{uboot_dir}/u-boot.elf /boot/efi/
  fi
fi
%endif

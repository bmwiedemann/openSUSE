...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-reservations/azure-cli-reservations-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-reservations-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-reservations-%{version}

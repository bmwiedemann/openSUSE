...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-storagemover/azure-mgmt-storagemover-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-storagemover-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-storagemover-%{realversion}
%python_build

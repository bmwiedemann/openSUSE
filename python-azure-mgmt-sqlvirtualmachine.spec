#
# spec file for package python-azure-mgmt-sqlvirtualmachine
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-sqlvirtualmachine/azure-mgmt-sqlvirtualmachine-%{version}.zip
Source1:        LICENSE.txt

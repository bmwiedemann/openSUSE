#
# spec file for package python-azure-mgmt-datamigration
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-datamigration/azure-mgmt-datamigration-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-datamigration-%{version}
%patch1 -p1
%patch2 -p1

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-datamigration-%{version}
%python_build
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/datamigration
%{python_sitelib}/azure_mgmt_datamigration-*.egg-info

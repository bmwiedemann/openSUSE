...
Requires:       (libavcodec62 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libavdevice62 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libavfilter11 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libavformat62 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libavutil60 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libswresample6 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
Requires:       (libswscale9 = %version-%release or ffmpeg-8-mini-libs = %version-%release)
...
%package -n libavcodec62
Summary:        FFmpeg codec library
Group:          System/Libraries
Requires:       libavutil60 = %version-%release
Requires:       libswresample6 = %version-%release
%if 0%{?BUILD_ORIG}
...
Provides:       libavcodec62(unrestricted)
%endif
# For mozillas
Provides:       libavcodec = %version-%release

%description -n libavcodec62
...
Requires:       libavcodec62 = %version-%release
...
%package -n libavdevice62
Summary:        FFmpeg device library
Group:          System/Libraries
Requires:       libavcodec62 = %version-%release
Requires:       libavfilter11 = %version-%release
Requires:       libavformat62 = %version-%release
Requires:       libavutil60 = %version-%release

%description -n libavdevice62
...
Requires:       libavdevice62 = %version-%release
%devel_conflicts -c < -v %_major_version
%devel_conflicts -c >= -v %_major_expected
...
Requires:       libavutil60 = %version-%release
Requires:       libswresample6 = %version-%release
Requires:       libswscale9 = %version-%release

%description -n libavfilter11
...
%package -n libavformat62
Summary:        FFmpeg's stream format library
Group:          System/Libraries
Requires:       libavcodec62 = %version-%release
Requires:       libavutil60 = %version-%release

%description -n libavformat62
...
%package -n libavutil60
Summary:        FFmpeg's utility library
Group:          System/Libraries

%description -n libavutil60
...
%package -n libswresample6
Summary:        FFmpeg software resampling library
Group:          System/Libraries
Requires:       libavutil60 = %version-%release

%description -n libswresample6
...
%package -n libswscale9
Summary:        FFmpeg image scaling and colorspace/pixel conversion library
Group:          System/Libraries
Requires:       libavutil60 = %version-%release

%description -n libswscale9
...
%ldconfig_scriptlets -n libavcodec62
%ldconfig_scriptlets -n libavdevice62
%ldconfig_scriptlets -n libavfilter11
%ldconfig_scriptlets -n libavformat62
%ldconfig_scriptlets -n libavutil60
%ldconfig_scriptlets -n libswresample6
%ldconfig_scriptlets -n libswscale9
...
%files -n libavcodec62
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavcodec.so.*

%files -n libavdevice62
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavdevice.so.*

%files -n libavfilter11
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavfilter.so.*

%files -n libavformat62
%license COPYING.GPLv2 LICENSE.md
...
Conflicts:      libavformat62
Conflicts:      libavutil60
Conflicts:      libswresample6
Conflicts:      libswscale9
Requires:       this-is-only-for-build-envs
...
cat config.h
%make_build
#	--enable-encoder="$(grep trivial %_sourcedir/enable_encoders | perl -pe 's{^(\w*).*}{$1,}gs')" \
#	--enable-decoder="$(grep trivial %_sourcedir/enable_decoders | perl -pe 's{^(\w*).*}{$1,}gs')" \

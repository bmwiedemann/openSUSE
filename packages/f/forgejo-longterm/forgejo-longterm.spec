#
# spec file for package forgejo-longterm
#
...
Requires:       git-core
Requires:       git-lfs
Requires:       (forgejo-longterm-apparmor if apparmor-abstractions)
Requires:       (forgejo-longterm-firewalld if firewalld)
Requires:       (forgejo-longterm-selinux if selinux-policy-targeted)
Conflicts:      forgejo
%if %{with apparmor}
...
Conflicts:      forgejo-environment-to-ini
Requires:       %{name} = %{version}-%{release}

#
# spec file for package ffmpeg-9
#
...
Requires:       (libavcodec63 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libavdevice63 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libavfilter12 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libavformat63 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libavutil61 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libswresample7 = %version-%release or ffmpeg-9-mini-libs = %version-%release)
Requires:       (libswscale10 = %version-%release or ffmpeg-9-mini-libs = %version-%release)

%description -n ffmpeg
FFmpeg is a multimedia framework, able to decode, encode,
transcode, mux, demux, stream, filter and play several formats
that humans and machines have created.
...
%package -n libavcodec63
Summary:        FFmpeg codec library
Group:          System/Libraries
Requires:       libavutil61 = %version-%release
Requires:       libswresample7 = %version-%release
%if 0%{?BUILD_ORIG}
...
Provides:       libavcodec63(unrestricted)
%endif
# For mozillas
Provides:       libavcodec = %version-%release

%description -n libavcodec63
...
Requires:       libavcodec63 = %version-%release
%devel_conflicts -c < -v %_lower_reject
%devel_conflicts -c >= -v %_upper_reject
...
%package -n libavdevice63
Summary:        FFmpeg device library
Group:          System/Libraries
Requires:       libavcodec63 = %version-%release
Requires:       libavfilter12 = %version-%release
Requires:       libavformat63 = %version-%release
Requires:       libavutil61 = %version-%release

%description -n libavdevice63
...
Requires:       libavdevice63 = %version-%release
%devel_conflicts -c < -v %_lower_reject
%devel_conflicts -c >= -v %_upper_reject
...
Requires:       libavutil61 = %version-%release
Requires:       libswresample7 = %version-%release
Requires:       libswscale10 = %version-%release

%description -n libavfilter12
...
%package -n libavformat63
Summary:        FFmpeg's stream format library
Group:          System/Libraries
Requires:       libavcodec63 = %version-%release
Requires:       libavutil61 = %version-%release

%description -n libavformat63
...
%package -n libavutil61
Summary:        FFmpeg's utility library
Group:          System/Libraries

%description -n libavutil61
...
%package -n libswresample7
Summary:        FFmpeg software resampling library
Group:          System/Libraries
Requires:       libavutil61 = %version-%release

%description -n libswresample7
...
%package -n libswscale10
Summary:        FFmpeg image scaling and colorspace/pixel conversion library
Group:          System/Libraries
Requires:       libavutil61 = %version-%release

%description -n libswscale10
...
%ldconfig_scriptlets -n libavcodec63
%ldconfig_scriptlets -n libavdevice63
%ldconfig_scriptlets -n libavfilter12
%ldconfig_scriptlets -n libavformat63
%ldconfig_scriptlets -n libavutil61
%ldconfig_scriptlets -n libswresample7
%ldconfig_scriptlets -n libswscale10
...
%files -n libavcodec63
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavcodec.so.*

%files -n libavdevice63
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavdevice.so.*

%files -n libavfilter12
%license COPYING.GPLv2 LICENSE.md
%_libdir/libavfilter.so.*

%files -n libavformat63
%license COPYING.GPLv2 LICENSE.md
...
%files -n libswresample7
%license COPYING.GPLv2 LICENSE.md
%_libdir/libswresample.so.*

%files -n libswscale10
%license COPYING.GPLv2 LICENSE.md
...
Conflicts:      libavformat63
Conflicts:      libavutil61
Conflicts:      libswresample7
Conflicts:      libswscale10
Requires:       this-is-only-for-build-envs

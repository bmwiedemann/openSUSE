#
# spec file for package kernel-firmware-dpaa2
#
...
%description
This package contains kernel firmware files for NXP Management Complex bus driver.


%prep
%autosetup -a1 -p1
# strip down WHENCE for the topic
scripts/strip-topic-whence.sh dpaa2 < WHENCE > WHENCE.new
...
scripts/install-licenses.sh dpaa2 %{buildroot}%{_licensedir}/%{name}

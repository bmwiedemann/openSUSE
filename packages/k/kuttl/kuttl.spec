...
%build
# COMMIT_HASH will be shortened by COMMIT_HASH:0:8 later
...
go build \
   ...
   -X github.com/kudobuilder/kuttl/pkg/version.gitCommit=${COMMIT_HASH:0:8} \
   -X github.com/kudobuilder/kuttl/pkg/version.buildDate=$BUILD_DATE" \

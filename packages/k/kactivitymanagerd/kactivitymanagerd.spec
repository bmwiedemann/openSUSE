...
Source:         https://download.kde.org/stable/plasma/5.22.2/kactivitymanagerd-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/stable/plasma/5.22.2/kactivitymanagerd-%{version}.tar.xz.sig

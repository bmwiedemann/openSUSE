...
Source1:        kubevirt-1.8_containers_meta
Source2:        kubevirt-1.8_containers_meta.service
...
%package -n     obs-service-kubevirt-1.8_containers_meta
...
%description -n obs-service-kubevirt-1.8_containers_meta
...
%files -n obs-service-kubevirt-1.8_containers_meta
%license LICENSE
%doc README.md
%dir %{_prefix}/lib/obs

...
podman run --rm --name kubectl \
      registry.opensuse.org/opensuse/kubectl:1.37 get nodes
```
...
podman run --rm --name kubectl \
      ...
      registry.opensuse.org/opensuse/kubectl:1.37 kustomize --enable-helm
```
...
podman run --rm --name kubectl \
      ...
      registry.opensuse.org/opensuse/kubectl:1.37 version

...
Supplements:    modalias(pci:v00008086d00004D45sv*sd*bc*sc*i*)
...
Supplements:    modalias(pci:v00008086d0000643Esv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00006E78sv*sd*bc*sc*i*)
...
Supplements:    modalias(pci:v00008086d00007D1Dsv*sd*bc*sc*i*)
...
Supplements:    modalias(pci:v00008086d0000AD1Dsv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d0000B03Esv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d0000D354sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d0000D71Dsv*sd*bc*sc*i*)
...
scripts/strip-topic-whence.sh intel < WHENCE-dist > WHENCE
...
scripts/strip-topic-whence.sh -t %{buildroot}%{_docdir}/%{name} intel < WHENCE-dist

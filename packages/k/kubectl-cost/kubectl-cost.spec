#
# spec file for package kubectl-cost
#
...
%description
kubectl-cost is a kubectl plugin that provides easy CLI access to Kubernetes
...
go build \
   ...
   -buildmode=pie \
   -ldflags=" \
   -X main.GitCommit=${COMMIT_HASH:0:8} \
   -X main.GitBranch=HEAD \
   -X main.GitState=clean \
   -X main.GitSummary=v%{version} \

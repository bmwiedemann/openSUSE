...
Name:           kernel-firmware-nvidia-jetson-36_4
...
rmdir lib/systemd
# usr/share/doc
mkdir -p usr/share/doc/packages/kernel-firmware-nvidia-jetson-36_4
mv usr/share/doc/{bluez,nvidia-l4t-firmware,nvidia-tegra} usr/share/doc/packages/kernel-firmware-nvidia-jetson-36_4
ln -snf service usr/sbin/rcnvwifibt
popd

%fdupes -s %{buildroot}/lib/firmware

%files -n kernel-firmware-nvidia-jetson-36_4
%doc /usr/share/doc/packages/kernel-firmware-nvidia-jetson-36_4/
/lib/firmware/
/usr/lib/systemd/

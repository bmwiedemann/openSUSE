...
Version:        5.0.14
Release:        0
Summary:        Deploy MinIO operator and tenants to Kubernetes using kubectl
License:        Apache-2.0
URL:            https://github.com/minio/operator
Source:         operator-%{version}.tar.gz
Source1:        vendor.tar.gz
Source2:        vendor-kubectl-minio.tar.gz
...
%setup -q -T -D -a 1 -n operator-%{version}
%setup -q -T -D -a 2 -n operator-%{version}/%{name}

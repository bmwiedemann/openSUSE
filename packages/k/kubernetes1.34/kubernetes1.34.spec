#
# spec file for package kubernetes1.34
#
...
# Patch to fix CVE-2026-41178 (go.opentelemetry.io/otel/baggage: no rejection of raw-length headers in baggage parsing allows for DoS via oversized inputs), bsc#1276659

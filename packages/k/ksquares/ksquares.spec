...
Obsoletes:      ksquares5 < %{version}
Provides:       ksquares5 = %{version}
...
%files
%license LICENSES/*
%doc %lang(en) %{_kf6_htmldir}/en/ksquares/
%{_kf6_applicationsdir}/org.kde.ksquares.desktop
%{_kf6_appstreamdir}/org.kde.ksquares.appdata.xml
%{_kf6_bindir}/ksquares
%{_kf6_configkcfgdir}/ksquares.kcfg
%{_kf6_iconsdir}/hicolor/*/*/ksquares.*

%files lang -f %{name}.lang
%exclude %{_kf6_htmldir}/en/ksquares/

...
%define git_version 6f221d80d2fa85bce0fb3cc68f8fc8ebaac4086a
...
scripts/strip-topic-whence.sh ath10k < WHENCE-dist > WHENCE
...
scripts/strip-topic-whence.sh -t %{buildroot}%{_docdir}/%{name} ath10k < WHENCE-dist

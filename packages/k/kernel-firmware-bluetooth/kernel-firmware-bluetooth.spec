...
%define git_version 18cf97993f06c0a28d88cee30b7b646807642acd
...
scripts/strip-topic-whence.sh bluetooth < WHENCE-dist > WHENCE
...
scripts/strip-topic-whence.sh -t %{buildroot}%{_docdir}/%{name} bluetooth < WHENCE-dist

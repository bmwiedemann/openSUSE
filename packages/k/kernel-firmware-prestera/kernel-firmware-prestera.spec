#
# spec file for package kernel-firmware-prestera
#
...
%description
This package contains kernel firmware files for Marvell Prestera ASIC driver.


%prep
%autosetup -a1 -p1
# strip down WHENCE for the topic
scripts/strip-topic-whence.sh prestera < WHENCE > WHENCE.new
...
scripts/install-licenses.sh prestera %{buildroot}%{_licensedir}/%{name}

...
%define git_version c95059a3774b1164a2d6a4db5371fb8406b22692
...
scripts/strip-topic-whence.sh ueagle < WHENCE-dist > WHENCE
...
scripts/strip-topic-whence.sh -t %{buildroot}%{_docdir}/%{name} ueagle < WHENCE-dist

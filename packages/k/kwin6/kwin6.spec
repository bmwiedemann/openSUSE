...
Name:           kwin6
Version:        6.2.1.1
%global _plasma6_bugfix 6.2.1
Release:        0
Summary:        KDE Window Manager
License:        GPL-2.0-or-later AND GPL-3.0-or-later
URL:            https://www.kde.org
Source:         https://download.kde.org/stable/plasma/6.2.1/%{rname}-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/plasma/6.2.1/%{rname}-%{version}.tar.xz.sig

#
# spec file for package kernel-firmware-nfp
#
...
%description
This package contains kernel firmware files for Netronome Flow Processor driver.


%prep
%autosetup -a1 -p1
# strip down WHENCE for the topic
scripts/strip-topic-whence.sh nfp < WHENCE > WHENCE.new
...
scripts/install-licenses.sh nfp %{buildroot}%{_licensedir}/%{name}

...
Source:         https://download.kde.org/stable/plasma/5.19.0/ksysguard-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/stable/plasma/5.19.0/ksysguard-%{version}.tar.xz.sig

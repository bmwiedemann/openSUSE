...
%endif
%endif
%global kernel_package kernel%kernel_flavor-srchash-b4a2f1cd357933360e85f345421a3a8e5011786a
%endif
%if 0%{?rhel_version}
...
Group:          SLES
Provides:       kernel-obs-build-srchash-b4a2f1cd357933360e85f345421a3a8e5011786a

...
%endif
%endif
%global kernel_package kernel%kernel_flavor-srchash-437be8832681838511717fe64b6fc051de6587be
%endif
%if 0%{?rhel_version}
...
Group:          SLES
Provides:       kernel-obs-build-srchash-437be8832681838511717fe64b6fc051de6587be

...
License:        MIT
URL:            https://github.com/navilg/k8senv
...
# https://github.com/navilg/k8senv/blob/main/build.sh#L7
sed -i "/^var gitCommit/ s/###GitCommitPlaceholder###/${COMMIT_HASH}/" ./internal/config/config.go

#
# spec file for package kernel-firmware-mwifiex
#
...
%description
This package contains kernel firmware files for Marvell WiFi fullmac drivers.


%prep
%autosetup -a1 -p1
# strip down WHENCE for the topic
scripts/strip-topic-whence.sh mwifiex < WHENCE > WHENCE.new
...
scripts/install-licenses.sh mwifiex %{buildroot}%{_licensedir}/%{name}

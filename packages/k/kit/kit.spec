...
Source0:        https://github.com/mark3labs/kit/archive/refs/tags/v%{version}.tar.gz#/%{name}-%{version}.tar.gz
Source1:        vendor.tar.gz
Patch100:       Limit-internal-tools-to-subagent-provide-adapted-system-prompt.patch
...
%build
go build -mod=vendor -buildmode=pie -o kit ./cmd/kit

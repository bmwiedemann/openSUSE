...
Supplements:    modalias(pci:v00008086d00001248sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001249sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d0000124Asv*sd*bc*sc*i*)
...
Supplements:    modalias(pci:v00008086d00001261sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001262sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001263sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001265sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001266sv*sd*bc*sc*i*)
Supplements:    modalias(pci:v00008086d00001267sv*sd*bc*sc*i*)
...
scripts/strip-topic-whence.sh network < WHENCE-dist > WHENCE
...
scripts/strip-topic-whence.sh -t %{buildroot}%{_docdir}/%{name} network < WHENCE-dist

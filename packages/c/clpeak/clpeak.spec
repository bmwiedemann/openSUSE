...
# GitHub archives carry no .git, so git-describe cannot run and the build would
# report "unknown" -- in --version and in the clpeak_version field of every
# JSON/XML/CSV export. Our source is exactly the tag Version names, so state it.
%cmake \

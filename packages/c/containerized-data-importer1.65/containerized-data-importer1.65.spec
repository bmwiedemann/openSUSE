...
Source1:        cdi1.65_containers_meta
Source2:        cdi1.65_containers_meta.service
...
# Heritage: also Provides/Obsoletes the dashed containerized-data-importer-1.65-*
# names that briefly shipped to Factory (2026-06) before the rename.
Provides:       containerized-data-importer-1.65-api = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-api < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-cloner = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-cloner < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-controller = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-controller < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-importer = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-importer < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-operator = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-operator < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-uploadproxy = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-uploadproxy < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-uploadserver = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-uploadserver < %{version}-%{release}
...
Provides:       containerized-data-importer-1.65-manifests = %{version}-%{release}
Obsoletes:      containerized-data-importer-1.65-manifests < %{version}-%{release}
...
Provides:       obs-service-cdi-1.65_containers_meta = %{version}-%{release}
Obsoletes:      obs-service-cdi-1.65_containers_meta < %{version}-%{release}
Summary:        CDI containers meta information (build service)
Group:          System/Packages

%description -n obs-service-cdi1.65_containers_meta

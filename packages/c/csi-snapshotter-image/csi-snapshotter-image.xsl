...
<image schemaversion="6.9" name="csi-snapshotter-image" xmlns:suse_label_helper="com.suse.label_helper">
  <description type="system">
    <author>SUSE Containers Team</author>
    <contact>containers@suse.com</contact>
    <specification>csi-snapshotter running on a <xsl:value-of select="param/os" /> container guest</specification>
  </description>
  <preferences>
    <type image="docker">
        ...
        <labels>
          <suse_label_helper:add_prefix>
            ...
            <label name="org.opencontainers.image.description">
              <xsl:attribute name="value">csi-snapshotter running on a <xsl:value-of select="param/os" /> container guest</xsl:attribute>
            </label>

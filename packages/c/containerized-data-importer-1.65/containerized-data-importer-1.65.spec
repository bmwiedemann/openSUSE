...
Name:           containerized-data-importer-1.65
Version:        1.65.0
Release:        0
...
Source1:        cdi-1.65_containers_meta
Source2:        cdi-1.65_containers_meta.service
...
Obsoletes:      containerized-data-importer-api < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-cloner < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-controller < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-importer < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-operator < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-uploadproxy < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-uploadserver < %{version}-%{release}
...
Obsoletes:      containerized-data-importer-manifests < %{version}-%{release}
...
%package -n     obs-service-cdi-1.65_containers_meta
...
%description -n obs-service-cdi-1.65_containers_meta
...
%files -n obs-service-cdi-1.65_containers_meta
%license LICENSE
%doc README.md
%dir %{_prefix}/lib/obs

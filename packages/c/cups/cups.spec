...
# wget --no-check-certificate -O cups-2.4.17-source.tar.gz https://github.com/OpenPrinting/cups/releases/download/v2.4.17/cups-2.4.17-source.tar.gz
Source0:        https://github.com/OpenPrinting/cups/releases/download/v2.4.17/cups-2.4.17-source.tar.gz
# To get Source1 go to https://github.com/OpenPrinting/cups/releases or use e.g.
# wget --no-check-certificate -O cups-2.4.17-source.tar.gz.sig https://github.com/OpenPrinting/cups/releases/download/v2.4.17/cups-2.4.17-source.tar.gz.sig
Source1:        https://github.com/OpenPrinting/cups/releases/download/v2.4.17/cups-2.4.17-source.tar.gz.sig
...
#   gpg --verify cups-2.4.17-source.tar.gz.sig cups-2.4.17-source.tar.gz

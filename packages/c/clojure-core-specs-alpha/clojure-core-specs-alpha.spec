#
# spec file for package clojure-core-specs-alpha
#
...
%global fragment core-specs-alpha
%global artifact_id core.specs.alpha
...
%description
This package provides specifications for clojure.core.
...
%endif
    --create --file=%{artifact_id}.jar -C src/main/clojure .
%else
%{mvn_build} -jf
%endif

...
%define my_pyver 3.14

%if 0%{suse_version} < 1600
%global pythons python314
%else
...
BuildRequires:  %{python_module base >= %{my_pyver}}
BuildRequires:  %{python_module beautifulsoup4 >= 4.14.3}
BuildRequires:  %{python_module chardet >= 5.2.0}
BuildRequires:  %{python_module css-parser >= 1.0.10}
BuildRequires:  %{python_module dateutil >= 2.9.0}
...
BuildRequires:  %{python_module inflate64 >= 1.0.4}
BuildRequires:  %{python_module jaconv >= 0.4.1}
BuildRequires:  %{python_module jeepney >= 0.9.0}
BuildRequires:  %{python_module lxml >= 6.0.2}
BuildRequires:  %{python_module lxml_html_clean >= 0.4.4}
BuildRequires:  %{python_module mechanize >= 0.4.10}
...
BuildRequires:  %{python_module pycryptodome >= 3.23.0}
# Not in suse BuildRequires:  %%{python_module pykakasi >= 2.3.0}
BuildRequires:  %{python_module pyppmd >= 1.3.1}
BuildRequires:  %{python_module pystache >= 0.6.8}
BuildRequires:  %{python_module regex >= 2025.11.3}
BuildRequires:  %{python_module sgmllib3k >= 1.0.0}
BuildRequires:  %{python_module soupsieve >= 2.8}
BuildRequires:  %{python_module texttable >= 1.7.0}
# Not in suse BuildRequires:  %%{python_module unrardll >= 0.1.7}
...
BuildRequires:  %{python_module pybind11 >= 3.0.1}
BuildRequires:  %{python_module pyproject-hooks >= 1.2.0}
...
Requires:       %{python_flavor}-Brotli >= 1.2.0
Requires:       %{python_flavor}-Deprecated >= 1.3.1
...
Requires:       %{python_flavor}-base >= %{my_pyver}
Requires:       %{python_flavor}-beautifulsoup4 >= 4.14.3
Requires:       %{python_flavor}-chardet >= 5.2.0
Requires:       %{python_flavor}-css-parser >= 1.0.10
...
Requires:       %{python_flavor}-ifaddr >= 0.2.0
Requires:       %{python_flavor}-inflate64 >= 1.0.4
Requires:       %{python_flavor}-jaconv >= 0.4.1
Requires:       %{python_flavor}-jeepney >= 0.9.0
Requires:       %{python_flavor}-lxml >= 6.0.2
Requires:       %{python_flavor}-lxml_html_clean >= 0.4.4
Requires:       %{python_flavor}-mechanize >= 0.4.10
Requires:       %{python_flavor}-msgpack >= 1.1.2
...
Requires:       %{python_flavor}-pycryptodome >= 3.23.0
# Not in suse Requires: %%{python_flavor}-pykakasi >= 2.3.0
Requires:       %{python_flavor}-pyppmd >= 1.3.1
Requires:       %{python_flavor}-pystache >= 0.6.8
Requires:       %{python_flavor}-regex >= 2025.11.3
Requires:       %{python_flavor}-sgmllib3k >= 1.0.0
Requires:       %{python_flavor}-soupsieve >= 2.8
Requires:       %{python_flavor}-texttable >= 1.7.0
# Not in suse Requires: %%{python_flavor}-unrardll >= 0.1.7
...
Requires:       %{python_flavor}-six >= 1.17.0
Requires:       %{python_flavor}-typing-extensions >= 4.15.0

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-dls/azure-cli-dls-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-dls-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-dls-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-vm/azure-cli-vm-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-vm-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-vm-%{version}

...
Version:        0.2.4
Release:        0
Summary:        Microsoft Azure CLI 'Content Delivery Network (CDN)' Command Module
License:        MIT
Group:          System/Management
Url:            https://github.com/Azure/azure-cli
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-cdn/azure-cli-cdn-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-cdn-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-cdn-%{version}

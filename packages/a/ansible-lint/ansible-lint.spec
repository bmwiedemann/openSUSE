...
BuildRequires:  (%{ansible_python}-pathspec >= 1.0.3 with %{ansible_python}-pathspec < 1.2.0)
...
Requires:       (%{ansible_python}-pathspec >= 1.0.3 with %{ansible_python}-pathspec < 1.2.0)

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-ams/azure-cli-ams-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-ams-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-ams-%{version}

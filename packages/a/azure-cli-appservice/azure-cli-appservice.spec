...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-appservice/azure-cli-appservice-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-appservice-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-appservice-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-eventhubs/azure-cli-eventhubs-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-eventhubs-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-eventhubs-%{version}

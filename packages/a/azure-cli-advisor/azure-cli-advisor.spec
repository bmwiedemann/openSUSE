#
# spec file for package azure-cli-advisor
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-advisor/azure-cli-advisor-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-advisor-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-advisor-%{version}

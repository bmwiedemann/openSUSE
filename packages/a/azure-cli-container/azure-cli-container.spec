...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-container/azure-cli-container-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-container-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-container-%{version}

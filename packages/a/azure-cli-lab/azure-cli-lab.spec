...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-lab/azure-cli-lab-%{version}.tar.gz
Source1:        LICENSE.txt
...
This package is for the 'lab' module.
i.e. 'az lab'

%prep
%setup -q -n azure-cli-lab-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-lab-%{version}

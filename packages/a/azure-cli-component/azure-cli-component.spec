...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-component/azure-cli-component-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-component-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-component-%{version}

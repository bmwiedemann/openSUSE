...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-iot/azure-cli-iot-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-iot-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-iot-%{version}

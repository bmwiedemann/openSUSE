#
# spec file for package azure-cli-policyinsights
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-policyinsights/azure-cli-policyinsights-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-policyinsights-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-policyinsights-%{version}
...
%license LICENSE.txt
%{python3_sitelib}/azure/cli/command_modules/policyinsights
%{python3_sitelib}/azure_cli_policyinsights-*.egg-info

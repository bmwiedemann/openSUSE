...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-resource/azure-cli-resource-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-resource-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-resource-%{version}

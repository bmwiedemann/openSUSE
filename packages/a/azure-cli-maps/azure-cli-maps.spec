#
# spec file for package azure-cli-maps
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-maps/azure-cli-maps-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-maps-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-maps-%{version}
...
%license LICENSE.txt
%{python3_sitelib}/azure/cli/command_modules/maps
%{python3_sitelib}/azure_cli_maps-*.egg-info

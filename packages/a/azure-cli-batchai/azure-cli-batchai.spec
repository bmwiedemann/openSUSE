...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-batchai/azure-cli-batchai-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-batchai-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-batchai-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-sql/azure-cli-sql-%{version}.tar.gz
Source1:        LICENSE.txt
...
This package is for the 'sql' module.
i.e. 'az sql'

%prep
%setup -q -n azure-cli-sql-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-sql-%{version}

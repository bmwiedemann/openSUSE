...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-role/azure-cli-role-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-role-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-role-%{version}

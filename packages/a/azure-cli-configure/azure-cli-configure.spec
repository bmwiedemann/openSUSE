...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-configure/azure-cli-configure-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-configure-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-configure-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-dms/azure-cli-dms-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-dms-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-dms-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-find/azure-cli-find-%{version}.tar.gz
Source1:        LICENSE.txt
...
This package is for the 'find' module.
i.e. 'az find'

%prep
%setup -q -n azure-cli-find-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-find-%{version}

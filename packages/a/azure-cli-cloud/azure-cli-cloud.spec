...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-cloud/azure-cli-cloud-%{version}.tar.gz
Source1:        LICENSE.txt
...
This package is for the 'cloud' module.
i.e. 'az cloud'

%prep
%setup -q -n azure-cli-cloud-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-cloud-%{version}

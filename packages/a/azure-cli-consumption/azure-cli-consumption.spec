...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-consumption/azure-cli-consumption-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-consumption-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-consumption-%{version}

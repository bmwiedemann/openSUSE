#
# spec file for package azure-cli-botservice
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-botservice/azure-cli-botservice-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-botservice-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-botservice-%{version}
...
%license LICENSE.txt
%{python3_sitelib}/azure/cli/command_modules/botservice
%{python3_sitelib}/azure_cli_botservice-*.egg-info

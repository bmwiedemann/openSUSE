...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-cognitiveservices/azure-cli-cognitiveservices-%{version}.tar.gz
Source1:        LICENSE.txt
...
%description
Microsoft Azure CLI 'cognitiveservices' Command Module

This package is for the 'cognitiveservices' module.
i.e. 'az cognitiveservices'

%prep
%setup -q -n azure-cli-cognitiveservices-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-cognitiveservices-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-storage/azure-cli-storage-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-storage-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-storage-%{version}

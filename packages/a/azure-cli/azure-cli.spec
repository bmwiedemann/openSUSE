...
BuildRequires:  python3-azure-mgmt-web >= 0.46.0
...
Requires:       python3-azure-mgmt-containerregistry >= 3.0.0rc12
Requires:       python3-azure-mgmt-containerservice >= 9.0.1
Requires:       python3-azure-mgmt-cosmosdb >= 0.14.0
...
Requires:       python3-azure-mgmt-loganalytics >= 0.6.0
...
Requires:       python3-azure-mgmt-network >= 10.2.0
...
Requires:       python3-azure-mgmt-web >= 0.46.0

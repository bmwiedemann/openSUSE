...
Requires:       azure-cli-telemetry < 2.0
...
Requires:       python3-azure-mgmt-compute >= 12.0
Requires:       python3-azure-mgmt-consumption >= 2.0
Requires:       python3-azure-mgmt-containerinstance >= 1.4
Requires:       python3-azure-mgmt-containerregistry >= 3.0.0rc11
Requires:       python3-azure-mgmt-containerservice >= 9.0.1
Requires:       python3-azure-mgmt-cosmosdb >= 0.13.0
...
Requires:       python3-azure-mgmt-eventhub >= 3.0.0
Requires:       python3-azure-mgmt-hdinsight >= 1.4.0
Requires:       python3-azure-mgmt-imagebuilder >= 0.2.1
Requires:       python3-azure-mgmt-iotcentral >= 3.0.0
Requires:       python3-azure-mgmt-iothub >= 0.11.0
...
Requires:       python3-azure-mgmt-loganalytics >= 0.5.0
...
Requires:       python3-azure-mgmt-media >= 1.1.1
Requires:       python3-azure-mgmt-monitor >= 0.9.0
Requires:       python3-azure-mgmt-msi >= 0.2
Requires:       python3-azure-mgmt-netapp >= 0.8.0
Requires:       python3-azure-mgmt-network >= 10.1.0
Requires:       python3-azure-mgmt-policyinsights >= 0.4.0
Requires:       python3-azure-mgmt-privatedns >= 0.1.0
Requires:       python3-azure-mgmt-rdbms >= 2.2.0
...
Requires:       python3-azure-mgmt-servicefabric >= 0.4.0
Requires:       python3-azure-mgmt-signalr >= 0.3.0
Requires:       python3-azure-mgmt-sql >= 0.18.0
Requires:       python3-azure-mgmt-sqlvirtualmachine >= 0.5.0
Requires:       python3-azure-mgmt-storage >= 9.0.0
Requires:       python3-azure-mgmt-trafficmanager >= 0.51.0
Requires:       python3-azure-mgmt-web >= 0.44.0
Requires:       python3-azure-multiapi-storage >= 0.3.1

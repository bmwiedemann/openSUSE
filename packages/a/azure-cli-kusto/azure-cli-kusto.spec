#
# spec file for package azure-cli-kusto
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-kusto/azure-cli-kusto-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-kusto-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-kusto-%{version}

...
%bcond_with kokkos
# Tests are timing out in OBS VMs, disable temporarily [badshah400, 2026-03-19]
%bcond_with test
%ifarch %ix86
...
%define dateword 22Jul2025       
%define uversion 22Jul2025_update3
Name:           lammps
Version:        20250722.03
Release:        0
...
Source0:        https://github.com/lammps/lammps/releases/download/stable_%{uversion}/lammps-src-%{uversion}.tar.gz#/%{name}-%{version}.tar.gz

...
# PATCH-FIX-UPSTREAM empty_url.patch
Patch0:         empty_url.patch
...
make config PREFIX="%{_prefix}" LIBDIR="%{_libdir}" SHAREDDIR=%{_datadir} FEATURES='vst3 lv2 vst2 clap doc jack standalone ladspa xdg gst ui launcher'
%make_build

...
# file, is the same license as for the pristine bindgenage itself (unless the
# license for the pristine bindgenage is not an Open Source License, in which

#
# spec file for package netfetch
#
...
License:        MIT
URL:            https://github.com/deggja/netfetch
Source:         %{name}-%{version}.tar.gz
Source1:        vendor.tar.gz
BuildRequires:  go >= 1.22

%description
This project aims to demystify network policies in Kubernetes. It's a work in
progress!
...
%prep
%autosetup -p 1
%setup -q -D -a 1 -n %{name}-%{version}/backend/
...
%files
# working directory is set to backend by the setup macro in pre
%doc ../README.md
%license ../LICENSE
%{_bindir}/%{name}

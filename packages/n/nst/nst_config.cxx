...
std::vector<KbdShortcut> get_kbd_shortcuts(Nst &nst) {
	...
	return {
		...
		{ Mask{Mod::SHIFT},     KeyID::PRIOR,       std::bind(&nst::Term::scrollHistoryUpByLines, &term, +10),   "scroll_history_up_slow" },
		{ Mask{Mod::SHIFT},     KeyID::NEXT,        std::bind(&nst::Term::scrollHistoryDownByLines, &term, +10), "scroll_history_down_slow" },
		{ TERMMOD,              KeyID::PRIOR,       std::bind(&nst::Term::scrollHistoryUpByPage, &term, +0.5),   "scroll_history_up_fast" },
		{ TERMMOD,              KeyID::NEXT,        std::bind(&nst::Term::scrollHistoryDownByPage, &term, +0.5), "scroll_history_down_fast" },
		{ TERMMOD,              KeyID::HOME,        std::bind(&nst::Term::scrollHistoryUpMax, &term), "scroll_history_up_max" },
		{ TERMMOD,              KeyID::END,         std::bind(&nst::Term::stopScrolling, &term), "stop_scrolling" },
		{ TERMMOD,              KeyID::B,           std::bind(&nst::Nst::pipeBufferToExternalCommand, &nst), "open_buffer_in_editor" },

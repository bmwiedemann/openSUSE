#
# spec file for package u-boot-socfpgade0nanosoc
#
...
%if "socfpgade0nanosoc" == "rpi" || "socfpgade0nanosoc" == "rpi2" || "socfpgade0nanosoc" == "rpi3"
%define is_rpi 1
%endif
%if "socfpgade0nanosoc" == "evb-rk3399" || "socfpgade0nanosoc" == "firefly-rk3399" || "socfpgade0nanosoc" == "puma-rk3399" || "socfpgade0nanosoc" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "socfpgade0nanosoc" == "bananapim64" || "socfpgade0nanosoc" == "nanopia64" || "socfpgade0nanosoc" == "pine64plus" || "socfpgade0nanosoc" == "pinebook"
%define is_a64 1
%endif
%if "socfpgade0nanosoc" == "orangepipc2"
%define is_h5 1
%endif
%if "socfpgade0nanosoc" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-socfpgade0nanosoc
Provides:       x-loader-socfpgade0nanosoc
%endif
...
This package contains the firmware for the socfpgade0nanosoc platform.

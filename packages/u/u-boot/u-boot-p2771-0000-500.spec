#
# spec file for package u-boot-p2771-0000-500
#
...
%if "p2771-0000-500" == "rpi" || "p2771-0000-500" == "rpi2" || "p2771-0000-500" == "rpi3"
%define is_rpi 1
%endif
%if "p2771-0000-500" == "evb-rk3399" || "p2771-0000-500" == "firefly-rk3399" || "p2771-0000-500" == "puma-rk3399" || "p2771-0000-500" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "p2771-0000-500" == "bananapim64" || "p2771-0000-500" == "nanopia64" || "p2771-0000-500" == "pine64plus" || "p2771-0000-500" == "pinebook"
%define is_a64 1
%endif
%if "p2771-0000-500" == "orangepipc2"
%define is_h5 1
%endif
%if "p2771-0000-500" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-p2771-0000-500
Provides:       x-loader-p2771-0000-500
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" p2771-0000-500_defconfig

...
%define is_rpi 1
%endif
%if "odroid" == "evb-rk3399" || "odroid" == "firefly-rk3399" || "odroid" == "puma-rk3399" || "odroid" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "odroid" == "bananapim64" || "odroid" == "nanopia64" || "odroid" == "pine64plus" || "odroid" == "pinebook"
%define is_a64 1
%endif
%if "odroid" == "orangepipc2"
%define is_h5 1
%endif
%if "odroid" == "pineh64"
%define is_h6 1
...
This package contains the firmware for the odroid platform.

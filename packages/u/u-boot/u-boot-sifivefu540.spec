#
# spec file for package u-boot-sifivefu540
#
...
%if "sifivefu540" == "rpi" || "sifivefu540" == "rpi2" || "sifivefu540" == "rpi3"
%define is_rpi 1
%endif
%if "sifivefu540" == "evb-rk3399" || "sifivefu540" == "firefly-rk3399" || "sifivefu540" == "puma-rk3399" || "sifivefu540" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "sifivefu540" == "bananapim64" || "sifivefu540" == "nanopia64" || "sifivefu540" == "pine64plus" || "sifivefu540" == "pinebook"
%define is_a64 1
%endif
%if "sifivefu540" == "orangepipc2"
%define is_h5 1
%endif
%if "sifivefu540" == "pineh64"
%define is_h6 1
%endif
...
Name:           u-boot-sifivefu540
Version:        2019.04
Release:        0
Summary:        The U-Boot firmware for the sifivefu540 platform
...
%if %x_loader == 1
Obsoletes:      x-loader-sifivefu540
Provides:       x-loader-sifivefu540
%endif
...
This package contains the firmware for the sifivefu540 platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" sifive_fu540_defconfig

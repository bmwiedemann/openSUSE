#
# spec file for package u-boot-pineh64
#
...
%if "pineh64" == "rpi" || "pineh64" == "rpi2" || "pineh64" == "rpi3"
%define is_rpi 1
%endif
%if "pineh64" == "evb-rk3399" || "pineh64" == "firefly-rk3399" || "pineh64" == "puma-rk3399" || "pineh64" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "pineh64" == "bananapim64" || "pineh64" == "nanopia64" || "pineh64" == "pine64plus" || "pineh64" == "pinebook"
%define is_a64 1
%endif
%if "pineh64" == "orangepipc2"
%define is_h5 1
%endif
%if "pineh64" == "pineh64"
%define is_h6 1
...
%if %x_loader == 1
Obsoletes:      x-loader-pineh64
Provides:       x-loader-pineh64
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" pine_h64_defconfig

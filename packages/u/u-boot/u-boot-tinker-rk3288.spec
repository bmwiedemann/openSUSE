#
# spec file for package u-boot-tinker-rk3288
#
...
%if "tinker-rk3288" == "rpi" || "tinker-rk3288" == "rpi2" || "tinker-rk3288" == "rpi3"
%define is_rpi 1
%endif
%if "tinker-rk3288" == "evb-rk3399" || "tinker-rk3288" == "firefly-rk3399" || "tinker-rk3288" == "puma-rk3399" || "tinker-rk3288" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "tinker-rk3288" == "bananapim64" || "tinker-rk3288" == "nanopia64" || "tinker-rk3288" == "pine64plus" || "tinker-rk3288" == "pinebook"
%define is_a64 1
%endif
%if "tinker-rk3288" == "orangepipc2"
%define is_h5 1
%endif
%if "tinker-rk3288" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-tinker-rk3288
Provides:       x-loader-tinker-rk3288
%endif
...
This package contains the firmware for the tinker-rk3288 platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" tinker-rk3288_defconfig

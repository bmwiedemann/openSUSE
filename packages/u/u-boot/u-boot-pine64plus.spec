...
%if "pine64plus" == "rpi" || "pine64plus" == "rpi2" || "pine64plus" == "rpi3"
%define is_rpi 1
%endif
%if "pine64plus" == "evb-rk3399" || "pine64plus" == "firefly-rk3399" || "pine64plus" == "puma-rk3399" || "pine64plus" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "pine64plus" == "bananapim64" || "pine64plus" == "nanopia64" || "pine64plus" == "pine64plus" || "pine64plus" == "pinebook"
%define is_a64 1
%endif
%if "pine64plus" == "orangepipc2"
%define is_h5 1
%endif
%if "pine64plus" == "pineh64"
%define is_h6 1
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" pine64_plus_defconfig

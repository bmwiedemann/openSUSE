...
%if "spring" == "rpi" || "spring" == "rpi2" || "spring" == "rpi3"
%define is_rpi 1
%endif
%if "spring" == "evb-rk3399" || "spring" == "firefly-rk3399" || "spring" == "puma-rk3399" || "spring" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "spring" == "bananapim64" || "spring" == "nanopia64" || "spring" == "pine64plus" || "spring" == "pinebook"
%define is_a64 1
%endif
%if "spring" == "orangepipc2"
%define is_h5 1
%endif
%if "spring" == "pineh64"
%define is_h6 1
...
This package contains the firmware for the spring platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" spring_defconfig

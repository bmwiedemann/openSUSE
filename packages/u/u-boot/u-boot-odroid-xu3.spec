...
%define is_rpi 1
%endif
%if "odroid-xu3" == "evb-rk3399" || "odroid-xu3" == "firefly-rk3399" || "odroid-xu3" == "puma-rk3399" || "odroid-xu3" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "odroid-xu3" == "bananapim64" || "odroid-xu3" == "nanopia64" || "odroid-xu3" == "pine64plus" || "odroid-xu3" == "pinebook"
%define is_a64 1
%endif
%if "odroid-xu3" == "orangepipc2"
%define is_h5 1
%endif
%if "odroid-xu3" == "pineh64"
%define is_h6 1
%endif
...
This package contains the firmware for the odroid-xu3 platform.

...
%if "qemu-ppce500" == "rpi" || "qemu-ppce500" == "rpi2" || "qemu-ppce500" == "rpi3"
%define is_rpi 1
%endif
%if "qemu-ppce500" == "evb-rk3399" || "qemu-ppce500" == "firefly-rk3399" || "qemu-ppce500" == "puma-rk3399" || "qemu-ppce500" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "qemu-ppce500" == "bananapim64" || "qemu-ppce500" == "nanopia64" || "qemu-ppce500" == "pine64plus" || "qemu-ppce500" == "pinebook"
%define is_a64 1
%endif
%if "qemu-ppce500" == "orangepipc2"
%define is_h5 1
%endif
%if "qemu-ppce500" == "pineh64"
%define is_h6 1
%endif
...
This package contains the firmware for the qemu-ppce500 platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" qemu-ppce500_defconfig

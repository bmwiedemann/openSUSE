#
# spec file for package u-boot-xilinxzynqmpzcu102rev10
#
...
%if "xilinxzynqmpzcu102rev10" == "rpi" || "xilinxzynqmpzcu102rev10" == "rpi2" || "xilinxzynqmpzcu102rev10" == "rpi3"
%define is_rpi 1
%endif
%if "xilinxzynqmpzcu102rev10" == "evb-rk3399" || "xilinxzynqmpzcu102rev10" == "firefly-rk3399" || "xilinxzynqmpzcu102rev10" == "puma-rk3399" || "xilinxzynqmpzcu102rev10" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "xilinxzynqmpzcu102rev10" == "bananapim64" || "xilinxzynqmpzcu102rev10" == "nanopia64" || "xilinxzynqmpzcu102rev10" == "pine64plus" || "xilinxzynqmpzcu102rev10" == "pinebook"
%define is_a64 1
%endif
%if "xilinxzynqmpzcu102rev10" == "orangepipc2"
%define is_h5 1
%endif
%if "xilinxzynqmpzcu102rev10" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-xilinxzynqmpzcu102rev10
Provides:       x-loader-xilinxzynqmpzcu102rev10
%endif
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" xilinx_zynqmp_zcu102_rev1_0_defconfig

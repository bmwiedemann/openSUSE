#
# spec file for package u-boot-udooneo
#
...
%if "udooneo" == "rpi" || "udooneo" == "rpi2" || "udooneo" == "rpi3"
%define is_rpi 1
%endif
%if "udooneo" == "evb-rk3399" || "udooneo" == "firefly-rk3399" || "udooneo" == "puma-rk3399" || "udooneo" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "udooneo" == "bananapim64" || "udooneo" == "nanopia64" || "udooneo" == "pine64plus" || "udooneo" == "pinebook"
%define is_a64 1
%endif
%if "udooneo" == "orangepipc2"
%define is_h5 1
%endif
%if "udooneo" == "pineh64"
%define is_h6 1
...
Version:        2019.04
Release:        0
Summary:        The U-Boot firmware for the udooneo platform
...
%if %x_loader == 1
Obsoletes:      x-loader-udooneo
Provides:       x-loader-udooneo
%endif
...
This package contains the firmware for the udooneo platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" udoo_neo_defconfig

...
%if "orangepipc" == "rpi" || "orangepipc" == "rpi2" || "orangepipc" == "rpi3"
%define is_rpi 1
%endif
%if "orangepipc" == "evb-rk3399" || "orangepipc" == "firefly-rk3399" || "orangepipc" == "puma-rk3399" || "orangepipc" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "orangepipc" == "bananapim64" || "orangepipc" == "nanopia64" || "orangepipc" == "pine64plus" || "orangepipc" == "pinebook"
%define is_a64 1
%endif
%if "orangepipc" == "orangepipc2"
%define is_h5 1
%endif
%if "orangepipc" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-orangepipc
Provides:       x-loader-orangepipc
%endif
...
This package contains the firmware for the orangepipc platform.

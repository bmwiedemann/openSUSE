#
# spec file for package u-boot-turrisomnia
#
...
%if "turrisomnia" == "rpi" || "turrisomnia" == "rpi2" || "turrisomnia" == "rpi3"
%define is_rpi 1
%endif
%if "turrisomnia" == "evb-rk3399" || "turrisomnia" == "firefly-rk3399" || "turrisomnia" == "puma-rk3399" || "turrisomnia" == "rock960-rk3399"
%define is_rk3399 1
%endif
%if "turrisomnia" == "bananapim64" || "turrisomnia" == "nanopia64" || "turrisomnia" == "pine64plus" || "turrisomnia" == "pinebook"
%define is_a64 1
%endif
%if "turrisomnia" == "orangepipc2"
%define is_h5 1
%endif
%if "turrisomnia" == "pineh64"
%define is_h6 1
%endif
...
%if %x_loader == 1
Obsoletes:      x-loader-turrisomnia
Provides:       x-loader-turrisomnia
%endif
...
This package contains the firmware for the turrisomnia platform.
...
make %{?_smp_mflags} CROSS_COMPILE= HOSTCFLAGS="$RPM_OPT_FLAGS" turris_omnia_defconfig

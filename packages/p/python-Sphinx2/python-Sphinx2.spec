#
# spec file for package python-Sphinx2
#
...
Source99:       python-Sphinx2-rpmlintrc
...
Recommends:     python-Sphinx2-doc-man
Recommends:     python-Whoosh >= 2.0
BuildArch:      noarch
%if %{with test}
BuildRequires:  %{python_module Sphinx2 = %{version}}
BuildRequires:  %{python_module Sphinx2-latex = %{version}}
...
Conflicts:      python-Sphinx-latex
Provides:       python-Sphinx-latex = %{version}
Requires:       python-Sphinx2 = %{version}
...
%package -n python-Sphinx2-doc
Summary:        Man files for python-Sphinx2
Group:          Documentation/Other
Conflicts:      python-Sphinx-doc
Provides:       python-Sphinx-doc = %{version}
Requires:       python3-Sphinx2 = %{version}

%description -n python-Sphinx2-doc
Sphinx is a tool that facilitates creating documentation for Python
projects (or other documents consisting of multiple reStructuredText
sources). It was originally created for the Python documentation, and
supports Python project documentation well, but C/C++ is likewise
...
%package -n python-Sphinx2-doc-man
Summary:        Man files for python-Sphinx2
Group:          Documentation/Man
Conflicts:      python-Sphinx-doc-man
Provides:       python-Sphinx-doc-man = %{version}
Requires:       python3-Sphinx2 = %{version}
Requires(post): update-alternatives
Requires(postun): update-alternatives
Supplements:    python3-Sphinx2
Obsoletes:      %{python_module Sphinx2-doc-man-common <= %{version}}

%description -n python-Sphinx2-doc-man
Sphinx is a tool that facilitates creating documentation for Python
projects (or other documents consisting of multiple reStructuredText
sources).
...
%package -n python-Sphinx2-doc-html
Summary:        HTML Documentation for python-Sphinx2
Group:          Documentation/HTML
Conflicts:      python-Sphinx-doc-html
Provides:       %{python_module Sphinx-doc-html = %{version}}
Provides:       %{python_module Sphinx2-doc-html = %{version}}
Provides:       python-Sphinx-doc-html = %{version}

%description -n python-Sphinx2-doc-html
Sphinx is a tool that facilitates creating documentation for Python
projects (or other documents consisting of multiple reStructuredText
sources).
...
%if %{with test}
%files -n python-Sphinx2-doc-man
%license LICENSE
%doc AUTHORS
...
%files -n python-Sphinx2-doc-html
%license LICENSE
%doc AUTHORS

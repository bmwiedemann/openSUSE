#
# spec file for package perl-MooX-Traits
#
...
Name:           perl-MooX-Traits
Version:        0.005
Release:        0
%define cpan_name MooX-Traits
...
BuildRequires:  perl(Role::Tiny) >= 1.000000
BuildRequires:  perl(Test::More) >= 0.96
BuildRequires:  perl(Test::Requires)
Requires:       perl(Exporter::Shiny)
Requires:       perl(Module::Runtime)
Requires:       perl(Role::Tiny) >= 1.000000
Recommends:     perl(Moo::Role)
%{perl_requires}

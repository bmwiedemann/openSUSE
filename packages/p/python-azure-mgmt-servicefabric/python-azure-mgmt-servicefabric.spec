...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-servicefabric/azure-mgmt-servicefabric-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-servicefabric < 2.1.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_servicefabric-*.dist-info

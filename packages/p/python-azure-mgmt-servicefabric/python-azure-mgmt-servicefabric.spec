...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-servicefabric/azure-mgmt-servicefabric-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-servicefabric-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-servicefabric-%{realversion}
%python_build

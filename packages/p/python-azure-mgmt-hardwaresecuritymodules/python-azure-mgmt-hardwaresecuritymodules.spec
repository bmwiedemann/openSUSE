...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-hardwaresecuritymodules/azure-mgmt-hardwaresecuritymodules-%{realversion}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-hardwaresecuritymodules < 1.0.0~b1
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-hardwaresecuritymodules-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-hardwaresecuritymodules-%{realversion}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/hardwaresecuritymodules
%{python_sitelib}/azure_mgmt_hardwaresecuritymodules-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-search-imagesearch/azure-cognitiveservices-search-imagesearch-%{version}.tar.gz
...
Obsoletes:      python3-azure-cognitiveservices-search-imagesearch <= 2.0.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_cognitiveservices_search_imagesearch-*.dist-info

#
# spec file for package python-azure-cognitiveservices-search-websearch
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-search-websearch/azure-cognitiveservices-search-websearch-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-cognitiveservices-search-websearch <= 2.0.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cognitiveservices-search-websearch-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_cognitiveservices_search_websearch-*.dist-info

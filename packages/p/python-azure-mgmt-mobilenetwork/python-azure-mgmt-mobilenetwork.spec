...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_mobilenetwork/azure_mgmt_mobilenetwork-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-mobilenetwork < 3.1.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_mobilenetwork-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/mobilenetwork
%{python_sitelib}/azure_mgmt_mobilenetwork-*.dist-info

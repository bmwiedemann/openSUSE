#
# spec file for package python-azure-mgmt-pineconevectordb
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_pineconevectordb/azure_mgmt_pineconevectordb-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_pineconevectordb-%{realversion}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/pineconevectordb
%{python_sitelib}/azure_mgmt_pineconevectordb-*.dist-info

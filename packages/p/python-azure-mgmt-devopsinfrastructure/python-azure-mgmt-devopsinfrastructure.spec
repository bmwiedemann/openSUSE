#
# spec file for package python-azure-mgmt-devopsinfrastructure
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/devopsinfrastructure
%{python_sitelib}/azure_mgmt_devopsinfrastructure-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-streamanalytics/azure-mgmt-streamanalytics-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-streamanalytics-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-streamanalytics-%{version}
%python_build

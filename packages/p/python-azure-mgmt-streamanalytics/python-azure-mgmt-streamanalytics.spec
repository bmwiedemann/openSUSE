...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-streamanalytics/azure-mgmt-streamanalytics-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-streamanalytics-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-streamanalytics-%{realversion}
%python_build

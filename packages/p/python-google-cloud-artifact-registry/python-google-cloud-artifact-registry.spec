...
Source:         https://files.pythonhosted.org/packages/source/g/google-cloud-artifact-registry/google-cloud-artifact-registry-%{version}.tar.gz
...
%prep
%autosetup -p1 -n google-cloud-artifact-registry-%{version}

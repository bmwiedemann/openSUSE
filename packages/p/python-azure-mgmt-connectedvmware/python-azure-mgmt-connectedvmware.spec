#
# spec file for package python-azure-mgmt-connectedvmware
#
...
Obsoletes:      python3-azure-mgmt-connectedvmware < 1.0.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/connectedvmware
%{python_sitelib}/azure_mgmt_connectedvmware-*.dist-info

#
# spec file for package python-azure-mgmt-disconnectedoperations
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/disconnectedoperations
%{python_sitelib}/azure_mgmt_disconnectedoperations-*.dist-info

#
# spec file for package python-azure-mgmt-astro
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-astro/azure-mgmt-astro-%{realversion}.tar.gz
...
%prep
%setup -q -n azure-mgmt-astro-%{realversion}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/astro
%{python_sitelib}/azure_mgmt_astro-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-eventhub/azure-mgmt-eventhub-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-eventhub < 11.0.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_eventhub-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-iothubprovisioningservices/azure-mgmt-iothubprovisioningservices-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-iothubprovisioningservices <= 1.1.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-iothubprovisioningservices-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/iothubprovisioningservices
%{python_sitelib}/azure_mgmt_iothubprovisioningservices-*.dist-info

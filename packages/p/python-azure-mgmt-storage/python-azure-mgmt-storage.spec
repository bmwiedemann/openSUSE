...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_storage/azure_mgmt_storage-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_storage-%{version}
...
%{python_sitelib}/azure_mgmt_storage-*.dist-info

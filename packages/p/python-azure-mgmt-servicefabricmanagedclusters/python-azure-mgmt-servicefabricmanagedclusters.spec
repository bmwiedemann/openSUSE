...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-servicefabricmanagedclusters/azure-mgmt-servicefabricmanagedclusters-%{version}.zip
Source1:        LICENSE.txt
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-servicefabricmanagedclusters-%{version}
%python_build
...
%{python_sitelib}/azure_mgmt_servicefabricmanagedclusters-*.egg-info

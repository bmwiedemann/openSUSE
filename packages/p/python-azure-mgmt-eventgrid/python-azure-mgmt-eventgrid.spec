...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_eventgrid/azure_mgmt_eventgrid-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-eventgrid < 10.2.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_eventgrid-%{version}
...
%{python_sitelib}/azure_mgmt_eventgrid-*.dist-info

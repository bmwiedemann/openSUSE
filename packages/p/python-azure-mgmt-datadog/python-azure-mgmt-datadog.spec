...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-datadog/azure-mgmt-datadog-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-datadog < 2.1.0
%endif
BuildArch:      noarch
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/datadog
%{python_sitelib}/azure_mgmt_datadog-*.dist-info

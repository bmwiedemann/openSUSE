...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_dns/azure_mgmt_dns-%{version}.tar.gz
...
Requires:       (python-azure-core >= 1.5.0 with python-azure-core < 2.0.0)
...
%prep
%setup -q -n azure_mgmt_dns-%{version}

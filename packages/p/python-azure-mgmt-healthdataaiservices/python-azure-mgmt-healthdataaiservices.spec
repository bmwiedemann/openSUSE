#
# spec file for package python-azure-mgmt-healthdataaiservices
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/healthdataaiservices
%{python_sitelib}/azure_mgmt_healthdataaiservices-*.dist-info

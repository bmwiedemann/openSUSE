#
# spec file for package python-pyroute2.ipset
#
...
Source:         https://files.pythonhosted.org/packages/source/p/pyroute2.ipset/pyroute2.ipset-%{version}.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-%{version}

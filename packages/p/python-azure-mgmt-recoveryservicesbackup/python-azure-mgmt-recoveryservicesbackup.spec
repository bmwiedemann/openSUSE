...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_recoveryservicesbackup/azure_mgmt_recoveryservicesbackup-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-recoveryservicesbackup < 9.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_recoveryservicesbackup-%{version}
...
%{python_sitelib}/azure_mgmt_recoveryservicesbackup-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_dynatrace/azure_mgmt_dynatrace-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-dynatrace < 2.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_dynatrace-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/dynatrace
%{python_sitelib}/azure_mgmt_dynatrace-*.dist-info

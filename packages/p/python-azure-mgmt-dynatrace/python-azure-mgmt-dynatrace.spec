...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-dynatrace/azure-mgmt-dynatrace-%{realversion}.zip
Source1:        LICENSE.txt
...
%{python_sitelib}/azure_mgmt_dynatrace-*.egg-info

...
BuildRequires:  %{python_module cryptography >= 43 with %python-cryptography < 53}
...
BuildRequires:  %{python_module nethsm >= 3 with %python-nethsm < 4}
...
Requires:       (python-cryptography >= 43 with python-cryptography < 53)
...
Requires:       (python-nethsm >= 3 with python-nethsm < 4)

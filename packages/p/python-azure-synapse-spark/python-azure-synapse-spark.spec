#
# spec file for package python-azure-synapse-spark
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-synapse-spark/azure-synapse-spark-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-synapse-spark <= 0.7.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-synapse-spark-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-synapse-spark-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/synapse/spark
%{python_sitelib}/azure_synapse_spark-*.dist-info

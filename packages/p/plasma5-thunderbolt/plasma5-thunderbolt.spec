...
Source:         https://download.kde.org/unstable/plasma/%{version}/plasma-thunderbolt-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/unstable/plasma/%{version}/plasma-thunderbolt-%{version}.tar.xz.sig

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-security/azure-mgmt-security-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-security-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-security-%{realversion}
%python_build

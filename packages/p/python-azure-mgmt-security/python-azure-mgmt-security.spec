...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-security/azure-mgmt-security-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-security < 6.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-security-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-security-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_security-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-portal/azure-mgmt-portal-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-portal-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-portal-%{version}
%python_build

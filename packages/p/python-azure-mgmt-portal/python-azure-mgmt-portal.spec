...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-portal/azure_mgmt_portal-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-portal < 1.0.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_portal-%{version}
...
%{python_sitelib}/azure_mgmt_portal-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_containerservice/azure_mgmt_containerservice-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-containerservice < 29.1.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_containerservice-%{version}
...
%{python_sitelib}/azure_mgmt_containerservice-*.dist-info

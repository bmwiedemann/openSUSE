...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_hybridcompute/azure_mgmt_hybridcompute-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_hybridcompute-%{version}

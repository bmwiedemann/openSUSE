...
Source:         https://files.pythonhosted.org/packages/source/c/certbot-dns-nsone/certbot_dns_nsone-%{version}.tar.gz
...
%{python_sitelib}/certbot_dns_nsone-%{version}.dist-info

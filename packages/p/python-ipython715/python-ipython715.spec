...
Obsoletes:      python-ipython-iptest < %{version}
Provides:       python-jupyter_ipython-iptest = %{version}
Obsoletes:      python-jupyter_ipython-iptest < %{version}

%description iptest
This package provides the iptest command, in the last version
which supports Python 3.6. It is used for testing software that

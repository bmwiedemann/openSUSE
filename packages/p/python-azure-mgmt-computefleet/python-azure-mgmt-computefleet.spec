...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_computefleet/azure_mgmt_computefleet-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_computefleet-%{version}

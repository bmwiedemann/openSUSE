#
# spec file for package python-azure-mgmt-computefleet
#
...
Name:           python-azure-mgmt-computefleet
Version:        1.0.0~b1
Release:        0
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-computefleet/azure-mgmt-computefleet-%{realversion}.tar.gz
...
%prep
%setup -q -n azure-mgmt-computefleet-%{realversion}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/computefleet
%{python_sitelib}/azure_mgmt_computefleet-*.dist-info

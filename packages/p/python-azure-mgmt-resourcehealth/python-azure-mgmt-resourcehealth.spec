...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_resourcehealth/azure_mgmt_resourcehealth-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_resourcehealth-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-resourcehealth/azure-mgmt-resourcehealth-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-resourcehealth < 1.0.0b5
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-resourcehealth-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-resourcehealth-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/resourcehealth
%{python_sitelib}/azure_mgmt_resourcehealth-*.dist-info

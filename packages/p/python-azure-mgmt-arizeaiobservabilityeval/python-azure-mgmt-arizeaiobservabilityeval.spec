#
# spec file for package python-azure-mgmt-arizeaiobservabilityeval
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/arizeaiobservabilityeval
%{python_sitelib}/azure_mgmt_arizeaiobservabilityeval-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-cdn/azure-mgmt-cdn-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-cdn < 13.0.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-cdn-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_cdn-*.dist-info

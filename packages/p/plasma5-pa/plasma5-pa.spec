...
Source:         https://download.kde.org/stable/plasma/5.18.4/plasma-pa-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/stable/plasma/5.18.4/plasma-pa-%{version}.tar.xz.sig

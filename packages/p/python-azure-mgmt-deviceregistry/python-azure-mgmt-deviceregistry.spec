...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_deviceregistry/azure_mgmt_deviceregistry-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_deviceregistry-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-search/azure-mgmt-search-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-search < 9.1.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-search-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-search-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_search-*.dist-info

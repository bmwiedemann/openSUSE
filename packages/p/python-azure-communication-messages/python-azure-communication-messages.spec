#
# spec file for package python-azure-communication-messages
#
...
%description
his package contains a Python SDK for Azure Communication Services
...
%license LICENSE
%{python_sitelib}/azure/communication/messages
%{python_sitelib}/azure_communication_messages-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_hanaonazure/azure_mgmt_hanaonazure-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_hanaonazure-%{version}

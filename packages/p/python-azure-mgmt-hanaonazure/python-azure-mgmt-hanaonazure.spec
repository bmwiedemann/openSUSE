...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-hanaonazure/azure-mgmt-hanaonazure-%{realversion}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-hanaonazure <= 1.0.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-hanaonazure-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-hanaonazure-%{realversion}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_hanaonazure-*.dist-info

...
Source:         https://download.kde.org/stable/plasma/5.18.4/kdeplasma-addons-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/stable/plasma/5.18.4/kdeplasma-addons-%{version}.tar.xz.sig

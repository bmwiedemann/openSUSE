...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_sql/azure_mgmt_sql-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_sql-%{realversion}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-imagebuilder/azure-mgmt-imagebuilder-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-imagebuilder-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-imagebuilder-%{realversion}
%python_build

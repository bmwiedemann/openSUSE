...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_imagebuilder/azure_mgmt_imagebuilder-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_imagebuilder-%{version}

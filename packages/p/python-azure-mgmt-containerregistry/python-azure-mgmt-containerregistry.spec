...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-containerregistry/azure-mgmt-containerregistry-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-containerregistry < 10.3.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-containerregistry-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_containerregistry-*.dist-info

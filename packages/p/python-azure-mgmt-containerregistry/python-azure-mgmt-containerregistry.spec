...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-containerregistry/azure-mgmt-containerregistry-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-containerregistry-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-containerregistry-%{realversion}
%python_build

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_guestconfig/azure_mgmt_guestconfig-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_guestconfig-%{version}

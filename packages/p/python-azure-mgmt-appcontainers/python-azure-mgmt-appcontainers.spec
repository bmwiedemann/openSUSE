...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-appcontainers/azure-mgmt-appcontainers-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-appcontainers-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-appcontainers-%{realversion}
%python_build
...
%{python_sitelib}/azure_mgmt_appcontainers-*.egg-info

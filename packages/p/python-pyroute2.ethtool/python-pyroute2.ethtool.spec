#
# spec file for package python-pyroute2.ethtool
#
...
Source:         https://files.pythonhosted.org/packages/source/p/pyroute2.ethtool/pyroute2.ethtool-%{version}.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-%{version}

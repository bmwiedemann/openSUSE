...
Source:         https://files.pythonhosted.org/packages/source/a/azure_keyvault_certificates/azure_keyvault_certificates-%{version}.tar.gz
...
%prep
%setup -q -n azure_keyvault_certificates-%{version}

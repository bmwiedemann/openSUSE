...
Requires:       layer-shell-qt6-imports >= %{_plasma6_bugfix}
...
# Those don't look very secure...
echo > components/waydroidintegrationplugin/kauth/CMakeLists.txt
echo > quicksettings/flashlight/kauth/CMakeLists.txt
...
# rpmlint will complain with 'hardlink-across-partition' if fdupes runs on %%buildroot directly
...
%{_kf6_plasmadir}/quicksettings/org.kde.plasma.quicksetting.kscreenosd/
...
%{_kf6_plasmadir}/quicksettings/org.kde.plasma.quicksetting.waydroid/
...
%{_kf6_qmldir}/org/kde/plasma/quicksetting/kscreenosd/
...
# Disabled until redone.
#%%{_kf6_sharedir}/dbus-1/system-services/org.kde.plasma.mobileshell.flashlighthelper.service
#%%{_kf6_sharedir}/dbus-1/system-services/org.kde.plasma.mobileshell.waydroidhelper.service
#%%{_kf6_sharedir}/dbus-1/system.d/org.kde.plasma.mobileshell.flashlighthelper.conf
#%%{_kf6_sharedir}/dbus-1/system.d/org.kde.plasma.mobileshell.waydroidhelper.conf
#%%{_kf6_sharedir}/polkit-1/actions/org.kde.plasma.mobileshell.flashlighthelper.policy
#%%{_kf6_sharedir}/polkit-1/actions/org.kde.plasma.mobileshell.waydroidhelper.policy

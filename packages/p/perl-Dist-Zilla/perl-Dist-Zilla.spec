...
BuildRequires:  perl(MooseX::Role::Parameterized) >= 1.10.0
...
BuildRequires:  perl(Path::Tiny) >= 0.52.0
...
BuildRequires:  perl(String::RewritePrefix) >= 0.6.0
...
Requires:       perl(File::ShareDir::Install) >= 0.30.0
...
Requires:       perl(MooseX::Role::Parameterized) >= 1.10.0
...
Requires:       perl(Text::Glob) >= 0.80.0

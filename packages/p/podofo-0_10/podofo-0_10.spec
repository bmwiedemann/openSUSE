...
%package -n libpodofo-%{major}_%{minor}-devel
Summary:        Development files for podofo
License:        LGPL-2.1-or-later
Group:          Development/Libraries/Other
Requires:       libboost_headers-devel
Requires:       libpodofo%{libver} = %{version}
Conflicts:      libpodofo-devel > %{version}

%description -n libpodofo-%{major}_%{minor}-devel
This package contains development files for podofo library.

%prep
%autosetup -n podofo-%{version} -p1
...
%files -n libpodofo-%{major}_%{minor}-devel
%license COPYING

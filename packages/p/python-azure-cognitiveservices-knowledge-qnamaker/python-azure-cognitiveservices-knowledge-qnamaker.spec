...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-knowledge-qnamaker/azure-cognitiveservices-knowledge-qnamaker-%{version}.tar.gz
...
Obsoletes:      python3-azure-cognitiveservices-knowledge-qnamaker <= 0.3.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_cognitiveservices_knowledge_qnamaker-*.dist-info

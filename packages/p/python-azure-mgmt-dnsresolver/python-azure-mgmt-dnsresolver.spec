...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_dnsresolver/azure_mgmt_dnsresolver-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-dnsresolver < 1.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_dnsresolver-%{version}
...
%{python_sitelib}/azure_mgmt_dnsresolver-*.dist-info

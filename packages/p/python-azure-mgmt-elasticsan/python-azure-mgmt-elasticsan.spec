#
# spec file for package python-azure-mgmt-elasticsan
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-elasticsan/azure-mgmt-elasticsan-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-elasticsan-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-elasticsan-%{version}
%python_build
...
%{python_sitelib}/azure_mgmt_elasticsan-*.egg-info

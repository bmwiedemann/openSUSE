#
# spec file for package python-pyroute2.nftables
#
...
Source:         https://files.pythonhosted.org/packages/source/p/pyroute2.nftables/pyroute2.nftables-%{version}.tar.gz
...
%prep
%setup -q -n pyroute2.nftables-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-attestation/azure-mgmt-attestation-%{realversion}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-attestation <= 1.0.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-attestation-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-attestation-%{realversion}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_attestation-*.dist-info

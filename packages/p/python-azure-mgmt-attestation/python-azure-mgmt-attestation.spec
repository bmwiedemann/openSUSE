...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_attestation/azure_mgmt_attestation-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_attestation-%{version}

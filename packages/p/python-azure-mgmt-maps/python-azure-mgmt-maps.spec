...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-maps/azure-mgmt-maps-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-maps < 2.1.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_maps-*.dist-info

...
Source:         https://github.com/ColinDuquesnoy/QDarkStyleSheet/archive/refs/tags/v.%{version}.tar.gz#/QDarkStyle-%{version}.tar.gz
...
%pre
%python_libalternatives_reset_alternative qdarkstyle qdarkstyle.example qdarkstyle.utils

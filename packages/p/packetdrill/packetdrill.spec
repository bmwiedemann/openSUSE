...
# -fno-strict-aliasing: the checksum code type-puns the packet buffer
# (reads a u8[] through u32*/u16*), which -O2 strict aliasing miscompiles
# and makes checksum_test fail; keep all other %%optflags.

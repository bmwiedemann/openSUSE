...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-datalake-analytics/azure-mgmt-datalake-analytics-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-datalake-analytics <= 0.6.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_datalake_analytics-*.dist-info

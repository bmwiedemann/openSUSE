...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-advisor/azure_mgmt_advisor-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-advisor <= 9.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_advisor-%{version}
...
%{python_sitelib}/azure_mgmt_advisor-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-netapp/azure-mgmt-netapp-%{version}.zip
Source1:        LICENSE.txt
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-netapp-%{version}
%python_build

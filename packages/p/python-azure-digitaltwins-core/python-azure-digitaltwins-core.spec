...
Source:         https://files.pythonhosted.org/packages/source/a/azure_digitaltwins_core/azure_digitaltwins_core-%{version}.tar.gz
...
Obsoletes:      python3-azure-digitaltwins-core < 1.2.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_digitaltwins_core-%{version}
...
%{python_sitelib}/azure_digitaltwins_core-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_costmanagement/azure_mgmt_costmanagement-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_costmanagement-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-costmanagement/azure-mgmt-costmanagement-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-costmanagement-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-costmanagement-%{realversion}
%python_build

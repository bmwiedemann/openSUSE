...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-costmanagement/azure-mgmt-costmanagement-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-costmanagement-%{version}

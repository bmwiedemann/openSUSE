...
Source:         https://files.pythonhosted.org/packages/source/a/azure_storage_blob/azure_storage_blob-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_storage_blob-%{realversion}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_recoveryservicessiterecovery/azure_mgmt_recoveryservicessiterecovery-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-recoveryservicessiterecovery < 1.2.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_recoveryservicessiterecovery-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/recoveryservicessiterecovery
%{python_sitelib}/azure_mgmt_recoveryservicessiterecovery-*.dist-info

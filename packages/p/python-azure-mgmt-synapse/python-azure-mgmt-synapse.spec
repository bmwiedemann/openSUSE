...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-synapse/azure-mgmt-synapse-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-synapse < 2.1.0b5
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_synapse-*.dist-info

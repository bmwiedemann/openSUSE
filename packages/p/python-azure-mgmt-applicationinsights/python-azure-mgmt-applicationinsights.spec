...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-applicationinsights/azure-mgmt-applicationinsights-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-applicationinsights-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-applicationinsights-%{realversion}
%python_build

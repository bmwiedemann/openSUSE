...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-hybridconnectivity/azure-mgmt-hybridconnectivity-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-hybridconnectivity-%{version}

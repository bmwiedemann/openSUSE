...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_apimanagement/azure_mgmt_apimanagement-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_apimanagement-%{version}

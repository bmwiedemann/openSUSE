...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-apimanagement/azure-mgmt-apimanagement-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-apimanagement < 4.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-apimanagement-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-apimanagement-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_apimanagement-*.dist-info

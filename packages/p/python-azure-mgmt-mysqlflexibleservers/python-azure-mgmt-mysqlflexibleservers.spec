#
# spec file for package python-azure-mgmt-mysqlflexibleservers
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/mysqlflexibleservers
%{python_sitelib}/azure_mgmt_mysqlflexibleservers-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_networkcloud/azure_mgmt_networkcloud-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_networkcloud-%{version}

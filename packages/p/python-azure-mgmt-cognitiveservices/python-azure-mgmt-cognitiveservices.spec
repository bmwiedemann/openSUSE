...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_cognitiveservices/azure_mgmt_cognitiveservices-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_cognitiveservices-%{version}

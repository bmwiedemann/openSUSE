...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_cognitiveservices/azure_mgmt_cognitiveservices-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_cognitiveservices-%{realversion}
...
%{python_sitelib}/azure_mgmt_cognitiveservices-*.dist-info

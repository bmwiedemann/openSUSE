#
# spec file for package python-azure-mgmt-maintenance
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-maintenance/azure-mgmt-maintenance-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-maintenance < 2.1.0
%endif
BuildArch:      noarch
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/maintenance
%{python_sitelib}/azure_mgmt_maintenance-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-maintenance/azure-mgmt-maintenance-%{realversion}.zip
Source1:        LICENSE.txt
...
%{python_sitelib}/azure_mgmt_maintenance-*.egg-info

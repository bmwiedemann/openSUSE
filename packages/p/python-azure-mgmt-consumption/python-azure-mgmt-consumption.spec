...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_consumption/azure_mgmt_consumption-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-consumption < 10.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_consumption-%{version}
...
%{python_sitelib}/azure_mgmt_consumption-*.dist-info

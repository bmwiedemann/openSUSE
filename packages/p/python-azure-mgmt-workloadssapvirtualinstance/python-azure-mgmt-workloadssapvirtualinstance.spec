#
# spec file for package python-azure-mgmt-workloadssapvirtualinstance
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/workloadssapvirtualinstance
%{python_sitelib}/azure_mgmt_workloadssapvirtualinstance-*.dist-info

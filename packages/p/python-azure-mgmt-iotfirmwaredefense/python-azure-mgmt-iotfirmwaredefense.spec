...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-iotfirmwaredefense/azure_mgmt_iotfirmwaredefense-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_iotfirmwaredefense-%{version}

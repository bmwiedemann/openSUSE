#
# spec file for package python-azure-mgmt-iotfirmwaredefense
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-iotfirmwaredefense/azure-mgmt-iotfirmwaredefense-%{realversion}.zip
Source1:        LICENSE.txt
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-iotfirmwaredefense-%{realversion}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/iotfirmwaredefense
%{python_sitelib}/azure_mgmt_iotfirmwaredefense-*.dist-info

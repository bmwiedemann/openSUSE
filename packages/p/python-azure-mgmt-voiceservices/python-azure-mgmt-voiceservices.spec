...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-voiceservices/azure-mgmt-voiceservices-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-voiceservices-%{version}

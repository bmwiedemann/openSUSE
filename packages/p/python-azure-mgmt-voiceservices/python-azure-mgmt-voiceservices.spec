...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-voiceservices/azure-mgmt-voiceservices-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-voiceservices-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-voiceservices-%{realversion}
%python_build

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-synapse-managedprivateendpoints/azure-synapse-managedprivateendpoints-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-synapse-managedprivateendpoints-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-synapse-managedprivateendpoints-%{version}
%python_build

...
%prep
%setup -q -n azure-cognitiveservices-anomalydetector-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cognitiveservices-anomalydetector-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_cognitiveservices_anomalydetector-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_batch/azure_mgmt_batch-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-batch < 17.2.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_batch-%{version}
...
%{python_sitelib}/azure_mgmt_batch-*.dist-info

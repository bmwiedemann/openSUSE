...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-cosmosdb/azure-mgmt-cosmosdb-%{version}.tar.gz
Source1:        LICENSE.txt
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-cosmosdb-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_cosmosdb-*.dist-info

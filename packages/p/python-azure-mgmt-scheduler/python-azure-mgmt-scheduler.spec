...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_scheduler/azure_mgmt_scheduler-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-scheduler <= 2.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_scheduler-%{version}
...
%{python_sitelib}/azure_mgmt_scheduler-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/o/opt-einsum/opt_einsum-%{version}.tar.gz
...
%python_expand sed -i 's@/usr/bin/env python@/usr/bin/python%{$python_bin_suffix}@' ./opt_einsum/parser.py
%build
%python_build

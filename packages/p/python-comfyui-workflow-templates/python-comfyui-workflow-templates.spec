...
BuildRequires:  %{python_module comfyui-workflow-templates-core >= 0.3.331}
BuildRequires:  %{python_module comfyui-workflow-templates-json >= 0.1.66}
BuildRequires:  %{python_module comfyui-workflow-templates-media-api >= 0.3.84}
BuildRequires:  %{python_module comfyui-workflow-templates-media-assets-01 >= 0.1.38}
...
Requires:       python-comfyui-workflow-templates-core >= 0.3.331
Requires:       python-comfyui-workflow-templates-json >= 0.1.66
Requires:       python-comfyui-workflow-templates-media-api >= 0.3.84
Requires:       python-comfyui-workflow-templates-media-assets-01 >= 0.1.38

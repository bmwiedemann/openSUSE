#
# spec file for package python-azure-mgmt-servicelinker
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-servicelinker/azure-mgmt-servicelinker-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-servicelinker-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-servicelinker-%{version}
%python_build
...
%{python_sitelib}/azure_mgmt_servicelinker-*.egg-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-media/azure-mgmt-media-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-media-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-media-%{realversion}
%python_build

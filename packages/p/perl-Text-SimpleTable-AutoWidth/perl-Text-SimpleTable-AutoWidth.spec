#
# spec file for package perl-Text-SimpleTable-AutoWidth
#
...
Version:        0.09
Release:        0
%define cpan_name Text-SimpleTable-AutoWidth
Summary:        Text::SimpleTable::AutoWidth - Simple eyecandy ASCII tables with auto-wi[cut]
License:        Artistic-1.0 OR GPL-1.0-or-later
Group:          Development/Libraries/Perl
URL:            https://metacpan.org/release/%{cpan_name}
Source0:        https://cpan.metacpan.org/authors/id/C/CU/CUB/%{cpan_name}-%{version}.tar.gz

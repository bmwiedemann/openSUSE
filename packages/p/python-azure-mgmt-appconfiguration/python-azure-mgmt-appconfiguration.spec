...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_appconfiguration/azure_mgmt_appconfiguration-%{realversion}.tar.gz
...
Obsoletes:      python3-azure-mgmt-appconfiguration < 3.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%prep
%setup -q -n azure_mgmt_appconfiguration-%{realversion}
...
%{python_sitelib}/azure_mgmt_appconfiguration-*.dist-info

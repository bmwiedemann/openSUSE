...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_appconfiguration/azure_mgmt_appconfiguration-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_appconfiguration-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-vmwarecloudsimple/azure-mgmt-vmwarecloudsimple-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-vmwarecloudsimple-%{version}

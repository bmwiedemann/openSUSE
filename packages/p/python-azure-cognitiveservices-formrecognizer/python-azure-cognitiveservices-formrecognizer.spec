...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-formrecognizer/azure-cognitiveservices-formrecognizer-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-cognitiveservices-formrecognizer <= 0.1.1
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-cognitiveservices-formrecognizer-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cognitiveservices-formrecognizer-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_cognitiveservices_formrecognizer-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-communication-chat/azure-communication-chat-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-communication-chat < 1.2.0
%endif
BuildArch:      noarch
%python_subpackages
...
%{python_sitelib}/azure_communication_chat-*.dist-info

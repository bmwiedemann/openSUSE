...
Source:         https://files.pythonhosted.org/packages/source/a/azure-synapse-monitoring/azure-synapse-monitoring-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-synapse-monitoring-%{version}

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_containerservicefleet/azure_mgmt_containerservicefleet-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_containerservicefleet-%{version}

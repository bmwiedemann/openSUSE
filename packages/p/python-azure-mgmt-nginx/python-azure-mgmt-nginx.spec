...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-nginx/azure-mgmt-nginx-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-nginx < 3.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%prep
%setup -q -n azure-mgmt-nginx-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-nginx-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/nginx
%{python_sitelib}/azure_mgmt_nginx-*.dist-info

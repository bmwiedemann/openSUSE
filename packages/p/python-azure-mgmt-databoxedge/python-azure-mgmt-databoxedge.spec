...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-databoxedge/azure-mgmt-databoxedge-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-databoxedge-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-databoxedge-%{version}
%python_build
...
%{python_sitelib}/azure_mgmt_databoxedge-*.egg-info

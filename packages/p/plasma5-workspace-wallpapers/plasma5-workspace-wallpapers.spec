...
Source:         https://download.kde.org/unstable/plasma/%{version}/plasma-workspace-wallpapers-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/unstable/plasma/%{version}/plasma-workspace-wallpapers-%{version}.tar.xz.sig

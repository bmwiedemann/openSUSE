...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_devtestlabs/azure_mgmt_devtestlabs-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_devtestlabs-%{version}

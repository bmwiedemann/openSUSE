...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-devtestlabs/azure-mgmt-devtestlabs-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-devtestlabs <= 9.0.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-devtestlabs-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_devtestlabs-*.dist-info

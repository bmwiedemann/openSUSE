#
# spec file for package python-azure-cognitiveservices-search-customsearch
#
...
Name:           python-azure-cognitiveservices-search-customsearch
Version:        0.3.0
Release:        0
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-search-customsearch/azure-cognitiveservices-search-customsearch-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-cognitiveservices-search-customsearch <= 0.3.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-cognitiveservices-search-customsearch-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cognitiveservices-search-customsearch-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/cognitiveservices/search/customsearch
%{python_sitelib}/azure_cognitiveservices_search_customsearch-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-azurearcdata/azure_mgmt_azurearcdata-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_azurearcdata-%{version}

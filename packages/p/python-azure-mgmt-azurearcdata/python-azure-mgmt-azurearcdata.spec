...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-azurearcdata/azure-mgmt-azurearcdata-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-azurearcdata-%{version}

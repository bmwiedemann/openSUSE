...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_standbypool/azure_mgmt_standbypool-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_standbypool-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/standbypool
%{python_sitelib}/azure_mgmt_standbypool-*.dist-info

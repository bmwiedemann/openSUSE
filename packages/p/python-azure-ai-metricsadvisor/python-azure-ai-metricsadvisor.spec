...
Source:         https://files.pythonhosted.org/packages/source/a/azure-ai-metricsadvisor/azure-ai-metricsadvisor-%{version}.tar.gz
...
Obsoletes:      python3-azure-ai-metricsadvisor < 1.0.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%{python_sitelib}/azure_ai_metricsadvisor-*.dist-info

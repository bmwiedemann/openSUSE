...
URL:            https://www.riverbankcomputing.com/software/pyqtgraphs
Source:         https://files.pythonhosted.org/packages/source/P/PyQt6-%{qtlib}/pyqt6_graphs-%{version}.tar.gz
...
Provides:       python-qtgraphs-qt6 = %{version}-%{release}
%python_subpackages
...
%prep
%autosetup -p1 -n pyqt6_graphs-%{version}
...
$python -c 'from PyQt6 import Qt%{qtlib}; assert Qt%{qtlib}.PYQT_GRAPHS_VERSION_STR == "%{version}"'
}
...
%{python_sitearch}/PyQt6/Qt%{qtlib}*.so
%{python_sitearch}/[Pp]y[Qq]t6_[Gg]raphs-%{version}.dist-info/

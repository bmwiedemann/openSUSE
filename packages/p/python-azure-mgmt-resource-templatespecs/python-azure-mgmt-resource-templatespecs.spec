#
# spec file for package python-azure-mgmt-resource-templatespecs
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_resource_templatespecs/azure_mgmt_resource_templatespecs-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_resource_templatespecs-%{realversion}
...
rm -rf %{buildroot}%{$python_sitelib}/azure/mgmt/resource/__init__.*
rm -rf %{buildroot}%{$python_sitelib}/azure/mgmt/resource/__pycache__
...
%license LICENSE
%{python_sitelib}/azure/mgmt/resource/templatespecs
%{python_sitelib}/azure_mgmt_resource_templatespecs-*.dist-info

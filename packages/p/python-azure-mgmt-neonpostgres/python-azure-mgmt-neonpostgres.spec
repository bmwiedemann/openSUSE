#
# spec file for package python-azure-mgmt-neonpostgres
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_neonpostgres/azure_mgmt_neonpostgres-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_neonpostgres-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/neonpostgres
%{python_sitelib}/azure_mgmt_neonpostgres-*.dist-info

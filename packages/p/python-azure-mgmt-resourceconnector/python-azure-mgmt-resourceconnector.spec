#
# spec file for package python-azure-mgmt-resourceconnector
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-resourceconnector/azure-mgmt-resourceconnector-%{realversion}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-resourceconnector < 1.0.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-resourceconnector-%{realversion}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/resourceconnector
%{python_sitelib}/azure_mgmt_resourceconnector-*.dist-info

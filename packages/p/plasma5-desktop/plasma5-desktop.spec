...
Source:         https://download.kde.org/stable/plasma/5.27.7/plasma-desktop-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/plasma/5.27.7/plasma-desktop-%{version}.tar.xz.sig

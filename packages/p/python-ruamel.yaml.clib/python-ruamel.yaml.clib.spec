...
Source:         https://files.pythonhosted.org/packages/source/r/ruamel.yaml.clib/ruamel_yaml_clib-%{version}.tar.gz
...
%{python_sitearch}/ruamel[_.]yaml[_.]clib-%{version}.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/P/PyQt6-%{qtlib}/pyqt6_datavisualization-%{version}.tar.gz
...
%prep
%autosetup -p1 -n pyqt6_datavisualization-%{version}
...
%{python_sitearch}/[Pp]y[Qq]t6_[Dd]ata[Vv]isualization-%{version}.dist-info/

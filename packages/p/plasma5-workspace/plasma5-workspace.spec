...
Source:         https://download.kde.org/stable/plasma/5.27.4/plasma-workspace-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/plasma/5.27.4/plasma-workspace-%{version}.tar.xz.sig

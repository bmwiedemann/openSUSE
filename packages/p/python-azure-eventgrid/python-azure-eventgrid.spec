#
# spec file for package python-azure-eventgrid
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_eventgrid/azure_eventgrid-%{version}.tar.gz
...
Obsoletes:      python3-azure-eventgrid < 4.17.0
%endif
BuildArch:      noarch

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-appplatform/azure-mgmt-appplatform-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-appplatform-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-appplatform-%{realversion}
%python_build

...
Obsoletes:      python3-azure-mgmt-appplatform < 9.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-appplatform-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_appplatform-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_sqlvirtualmachine/azure_mgmt_sqlvirtualmachine-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-sqlvirtualmachine < 1.0.0b6
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_sqlvirtualmachine-%{version}
...
%{python_sitelib}/azure_mgmt_sqlvirtualmachine-*.dist-info

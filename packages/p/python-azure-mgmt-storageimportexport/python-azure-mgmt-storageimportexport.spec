...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-storageimportexport/azure-mgmt-storageimportexport-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-storageimportexport-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-storageimportexport-%{version}
%python_build

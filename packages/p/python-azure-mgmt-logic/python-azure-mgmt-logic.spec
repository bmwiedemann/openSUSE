...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-logic/azure-mgmt-logic-%{version}.zip
Source1:        LICENSE.txt
Patch1:         aml_drop-compatible-releases-operator.patch
Patch2:         aml_drop-extras-require.patch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-logic-%{version}
%python_build

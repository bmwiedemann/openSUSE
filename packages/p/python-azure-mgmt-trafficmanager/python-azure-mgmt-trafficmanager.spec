...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-trafficmanager/azure-mgmt-trafficmanager-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-trafficmanager < 1.1.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_mgmt_trafficmanager-*.dist-info

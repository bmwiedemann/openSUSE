#
# spec file for package python-azure-planetarycomputer
#
...
Name:           python-azure-planetarycomputer
Version:        1.0.0~b1
Release:        0
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_planetarycomputer/azure_planetarycomputer-%{realversion}.tar.gz
...
Requires:       (python-azure-core >= 1.35.0 with python-azure-core < 2.0.0)
Requires:       (python-isodate >= 0.6.1 with python-isodate < 1.0.0)
Requires:       python-typing_extensions >= 4.6.0
Conflicts:      python-azure-sdk <= 2.0.0
%if 0%{?sle_version} >= 150400
Obsoletes:      python3-azure-planetarycomputer <= 0.61.1
%endif
BuildArch:      noarch
...
%description
The Azure Planetary Computer client library provides programmatic access to
...
%prep
%setup -q -n azure_planetarycomputer-%{realversion}
...
%license LICENSE
%{python_sitelib}/azure/planetarycomputer
%{python_sitelib}/azure_planetarycomputer-*.dist-info

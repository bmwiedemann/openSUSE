...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-search-videosearch/azure-cognitiveservices-search-videosearch-%{version}.tar.gz
...
Obsoletes:      python3-azure-cognitiveservices-search-videosearch <= 2.0.0
%endif
BuildArch:      noarch
...
%{python_sitelib}/azure_cognitiveservices_search_videosearch-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_education/azure_mgmt_education-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_education-%{realversion}

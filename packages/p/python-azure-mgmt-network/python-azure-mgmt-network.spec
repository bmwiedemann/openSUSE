...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_network/azure_mgmt_network-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-network < 25.3.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_network-%{version}

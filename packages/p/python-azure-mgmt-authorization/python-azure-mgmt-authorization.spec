...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-authorization/azure_mgmt_authorization-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_authorization-%{realversion}

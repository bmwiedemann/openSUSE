#
# spec file for package python-azure-mgmt-storageactions
#
...
Obsoletes:      python3-azure-mgmt-storageactions < 1.0.0~b1
%endif
BuildArch:      noarch
...
%license LICENSE
%{python_sitelib}/azure/mgmt/storageactions
%{python_sitelib}/azure_mgmt_storageactions-*.dist-info

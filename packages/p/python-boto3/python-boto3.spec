...
BuildRequires:  %{python_module botocore < 1.18.0}
BuildRequires:  %{python_module botocore >= 1.17.40}
...
Requires:       python-botocore < 1.18.0
Requires:       python-botocore >= 1.17.40

...
Requires:       (python-jsonschema-path >= 0.5.0 with python-jsonschema-path < 0.6)
...
BuildRequires:  %{python_module jsonschema-path >= 0.5.0 with %python-jsonschema-path < 0.6}

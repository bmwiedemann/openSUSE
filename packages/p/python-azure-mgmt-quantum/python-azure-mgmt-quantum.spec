...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-quantum/azure-mgmt-quantum-%{version}.tar.gz
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-quantum < 1.0.0b3
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-quantum-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-quantum-%{version}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/quantum
%{python_sitelib}/azure_mgmt_quantum-*.dist-info

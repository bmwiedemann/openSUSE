#
# spec file for package python-azure-mgmt-redhatopenshift
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-redhatopenshift/azure-mgmt-redhatopenshift-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-redhatopenshift-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-redhatopenshift-%{realversion}
%python_build
...
%{python_sitelib}/azure_mgmt_redhatopenshift-*.egg-info

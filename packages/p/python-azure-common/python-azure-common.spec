...
Source:         https://files.pythonhosted.org/packages/source/a/azure-common/azure-common-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-common-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-common-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_common-*.dist-info

#
# spec file for package python-azure-mgmt-carbonoptimization
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/carbonoptimization
%{python_sitelib}/azure_mgmt_carbonoptimization-*.dist-info

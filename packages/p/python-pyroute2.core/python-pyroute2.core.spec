#
# spec file for package python-pyroute2.core
#
...
Source:         https://files.pythonhosted.org/packages/source/p/pyroute2.core/pyroute2.core-%{version}.tar.gz
...
%prep
%setup -q -n pyroute2.core-%{version}

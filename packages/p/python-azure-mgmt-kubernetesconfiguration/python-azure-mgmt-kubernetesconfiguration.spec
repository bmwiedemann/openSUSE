...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-kubernetesconfiguration/azure-mgmt-kubernetesconfiguration-%{realversion}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-kubernetesconfiguration-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-kubernetesconfiguration-%{realversion}
%python_build

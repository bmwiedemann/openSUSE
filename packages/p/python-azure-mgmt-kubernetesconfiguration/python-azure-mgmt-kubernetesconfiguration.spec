...
Obsoletes:      python3-azure-mgmt-kubernetesconfiguration < 3.1.0
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-kubernetesconfiguration-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_kubernetesconfiguration-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_loganalytics/azure_mgmt_loganalytics-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_loganalytics-%{version}

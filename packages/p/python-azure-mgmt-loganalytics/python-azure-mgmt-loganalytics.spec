...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-loganalytics/azure-mgmt-loganalytics-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-loganalytics < 13.0.0b5
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-loganalytics-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-loganalytics-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_loganalytics-*.dist-info

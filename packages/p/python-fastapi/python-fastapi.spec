...
BuildRequires:  %{python_module PyJWT >= 2.9.0}
...
BuildRequires:  %{python_module coverage >= 7.13}
BuildRequires:  %{python_module dirty-equals >= 0.9.0}
BuildRequires:  %{python_module email-validator >= 2.0.0}
...
BuildRequires:  %{python_module inline-snapshot >= 0.21.1}

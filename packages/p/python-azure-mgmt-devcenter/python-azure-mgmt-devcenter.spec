...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-devcenter/azure-mgmt-devcenter-%{realversion}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-devcenter < 1.0.0.0
%endif
BuildArch:      noarch
%python_subpackages
...
%prep
%setup -q -n azure-mgmt-devcenter-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-devcenter-%{realversion}
%pyproject_wheel
...
%license LICENSE.txt
%{python_sitelib}/azure/mgmt/devcenter
%{python_sitelib}/azure_mgmt_devcenter-*.dist-info

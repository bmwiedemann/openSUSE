...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-devcenter/azure-mgmt-devcenter-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-devcenter-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-devcenter-%{version}
%pyproject_wheel

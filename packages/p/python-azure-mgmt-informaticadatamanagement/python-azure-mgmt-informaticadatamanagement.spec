#
# spec file for package python-azure-mgmt-informaticadatamanagement
#
...
%license LICENSE
%{python_sitelib}/azure/mgmt/informaticadatamanagement
%{python_sitelib}/azure_mgmt_informaticadatamanagement-*.dist-info

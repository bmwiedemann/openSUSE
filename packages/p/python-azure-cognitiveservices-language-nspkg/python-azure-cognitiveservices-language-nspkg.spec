...
mkdir -p %{buildroot}%{python2_sitelib}/azure/cognitiveservices/language
mkdir -p %{buildroot}%{python3_sitelib}/azure/cognitiveservices/language

%files %{python_files}
%defattr(-,root,root,-)
%doc README.rst
%license LICENSE.txt
%python2_only %{python2_sitelib}/azure/cognitiveservices/language
%python3_only %dir %{python3_sitelib}/azure/cognitiveservices/language

...
Source0:        https://files.pythonhosted.org/packages/source/p/pyghmi/pyghmi-1.5.68.tar.gz
...
%build
%{py3_build}
PYTHONPATH=. PBR_VERSION=1.5.68 %sphinx_build -b html doc/source doc/build/html

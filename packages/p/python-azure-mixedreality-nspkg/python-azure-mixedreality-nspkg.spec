...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mixedreality-nspkg/azure-mixedreality-nspkg-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mixedreality-nspkg-%{version}

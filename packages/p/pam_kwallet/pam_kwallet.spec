...
Source:         https://download.kde.org/unstable/plasma/%{version}/kwallet-pam-%{version}.tar.xz
%if %{with lang}
Source1:        https://download.kde.org/unstable/plasma/%{version}/kwallet-pam-%{version}.tar.xz.sig

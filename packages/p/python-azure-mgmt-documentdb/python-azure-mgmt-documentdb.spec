...
Name:           python-azure-mgmt-documentdb
Version:        0.1.3
Release:        0
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-documentdb/azure-mgmt-documentdb-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-documentdb-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-documentdb-%{version}
%python_build

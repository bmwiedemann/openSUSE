...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-hdinsight/azure-mgmt-hdinsight-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-hdinsight-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-hdinsight-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_hdinsight-*.dist-info

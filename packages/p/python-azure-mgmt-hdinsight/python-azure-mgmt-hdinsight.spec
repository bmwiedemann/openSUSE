...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_hdinsight/azure_mgmt_hdinsight-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_hdinsight-%{realversion}

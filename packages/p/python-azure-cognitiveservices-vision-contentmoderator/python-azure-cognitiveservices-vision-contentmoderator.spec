...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-vision-contentmoderator/azure-cognitiveservices-vision-contentmoderator-%{version}.zip
Source1:        LICENSE.txt
Patch1:         acvc_drop-compatible-releases-operator.patch
Patch2:         acvc_drop-extras-require.patch
...
%{python_sitelib}/azure_cognitiveservices_vision_contentmoderator-*.egg-info

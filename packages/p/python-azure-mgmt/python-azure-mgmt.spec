...
Requires:       python-azure-mgmt-loganalytics >= 0.5.0
...
Requires:       python-azure-mgmt-monitor >= 0.9.0
...
Requires:       python-azure-mgmt-network >= 10.1.0
...
Requires:       python-azure-mgmt-recoveryservicesbackup >= 0.6.0
...
Requires:       python-azure-mgmt-resource < 10.0.0
...
Requires:       python-azure-mgmt-synapse >= 0.2.0
...
Requires:       python-azure-mgmt-web >= 0.46.0

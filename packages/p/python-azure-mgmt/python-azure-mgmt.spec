...
Requires:       python-azure-mgmt-cognitiveservices < 4.0.0
...
Requires:       python-azure-mgmt-compute >= 4.4.0
...
Requires:       python-azure-mgmt-containerregistry >= 2.7.0
Requires:       python-azure-mgmt-containerservice < 5.0.0
Requires:       python-azure-mgmt-containerservice >= 4.4.0
...
Requires:       python-azure-mgmt-datamigration >= 2.1.0
...
Requires:       python-azure-mgmt-devtestlabs >= 3.0.0
Requires:       python-azure-mgmt-dns < 3.0.0
Requires:       python-azure-mgmt-dns >= 2.1.0
...
Requires:       python-azure-mgmt-eventhub >= 2.3.0
Requires:       python-azure-mgmt-hanaonazure < 1.0.0
Requires:       python-azure-mgmt-hanaonazure >= 0.4.0
Requires:       python-azure-mgmt-hdinsight < 1.0.0
Requires:       python-azure-mgmt-hdinsight >= 0.2.1
...
Requires:       python-azure-mgmt-keyvault >= 1.1.0
...
Requires:       python-azure-mgmt-msi >= 0.2.0
Requires:       python-azure-mgmt-network < 3.0.0
Requires:       python-azure-mgmt-network >= 2.6.0
...
Requires:       python-azure-mgmt-resource < 3.0.0
Requires:       python-azure-mgmt-resource >= 2.1.0
...
Requires:       python-azure-mgmt-storage >= 3.1.1

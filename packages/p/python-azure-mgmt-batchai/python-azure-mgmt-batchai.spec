...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_batchai/azure_mgmt_batchai-%{realversion}.tar.gz
...
%prep
%setup -q -n azure_mgmt_batchai-%{realversion}

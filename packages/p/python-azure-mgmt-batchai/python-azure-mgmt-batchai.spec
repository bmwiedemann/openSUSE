#
# spec file for package python-azure-mgmt-batchai
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-batchai/azure-mgmt-batchai-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-batchai <= 7.0.0b1
%endif
BuildArch:      noarch
...
%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-batchai-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_batchai-*.dist-info

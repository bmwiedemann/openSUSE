#
# spec file for package python-azure-mgmt-peering
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-peering/azure-mgmt-peering-%{realversion}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-peering <= 1.0.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-peering-%{realversion}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-peering-%{realversion}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_peering-*.dist-info

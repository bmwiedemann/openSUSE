...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-peering/azure-mgmt-peering-%{version}.zip
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-peering-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-peering-%{version}
%python_build

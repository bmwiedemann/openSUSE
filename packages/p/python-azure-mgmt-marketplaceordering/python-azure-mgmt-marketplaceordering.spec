...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_marketplaceordering/azure_mgmt_marketplaceordering-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-marketplaceordering <= 1.1.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_marketplaceordering-%{version}
...
%{python_sitelib}/azure_mgmt_marketplaceordering-*.dist-info

...
Source:         https://download.kde.org/stable/plasma/5.27.7/plasma-sdk-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/plasma/5.27.7/plasma-sdk-%{version}.tar.xz.sig

#
# spec file for package python-pyroute2.ipdb
#
...
Source:         https://files.pythonhosted.org/packages/source/p/pyroute2.ipdb/pyroute2.ipdb-%{version}.tar.gz
...
%prep
%setup -q -n pyroute2.ipdb-%{version}

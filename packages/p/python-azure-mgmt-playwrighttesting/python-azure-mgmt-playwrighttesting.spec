...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_playwrighttesting/azure_mgmt_playwrighttesting-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_playwrighttesting-%{version}

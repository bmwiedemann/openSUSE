...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cognitiveservices-language-spellcheck/azure-cognitiveservices-language-spellcheck-%{version}.zip
Source1:        LICENSE.txt
Patch1:         acls_drop-compatible-releases-operator.patch
...
%prep
%setup -q -n azure-cognitiveservices-language-spellcheck-%{version}
%patch1 -p1

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cognitiveservices-language-spellcheck-%{version}
%python_build
...
%{python_sitelib}/azure_cognitiveservices_language_spellcheck-*.egg-info

...
Name:           python-azure-mgmt-notificationhubs
Version:        8.0.0
Release:        0
...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-notificationhubs/azure-mgmt-notificationhubs-%{version}.zip
Source1:        LICENSE.txt
...
Obsoletes:      python3-azure-mgmt-notificationhubs <= 8.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure-mgmt-notificationhubs-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-notificationhubs-%{version}
%pyproject_wheel
...
%{python_sitelib}/azure_mgmt_notificationhubs-*.dist-info

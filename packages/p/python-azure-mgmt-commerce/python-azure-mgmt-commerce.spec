...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_commerce/azure_mgmt_commerce-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-commerce <= 6.0.0
%endif
BuildArch:      noarch
...
%prep
%setup -q -n azure_mgmt_commerce-%{version}
...
%{python_sitelib}/azure_mgmt_commerce-*.dist-info

...
Source:         https://files.pythonhosted.org/packages/source/a/azure-mgmt-support/azure-mgmt-support-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-mgmt-support-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-mgmt-support-%{version}
%pyproject_wheel

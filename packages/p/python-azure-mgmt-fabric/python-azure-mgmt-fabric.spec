#
# spec file for package python-azure-mgmt-fabric
#
...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_fabric/azure_mgmt_fabric-%{version}.tar.gz
...
%prep
%setup -q -n azure_mgmt_fabric-%{version}
...
%license LICENSE
%{python_sitelib}/azure/mgmt/fabric
%{python_sitelib}/azure_mgmt_fabric-*.dist-info

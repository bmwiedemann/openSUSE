...
Source:         https://files.pythonhosted.org/packages/source/a/azure_mgmt_keyvault/azure_mgmt_keyvault-%{version}.tar.gz
...
Obsoletes:      python3-azure-mgmt-keyvault < 10.3.0
%endif
BuildArch:      noarch
%python_subpackages
...
%{python_sitelib}/azure_mgmt_keyvault-*.dist-info

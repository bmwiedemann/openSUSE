...
Name:           python-jsonschema417%{psuffix}
Version:        4.17.3
Release:        0
...
Conflicts:      python-jsonschema >= 4.18
%python_subpackages
...
Provides:       python-jsonschema-format = %{version}-%{release}
Obsoletes:      python-jsonschema-format < 4.17.3
Conflicts:      python-jsonschema-format >= 4.18
...
Requires:       python-uri_template
Requires:       python-webcolors >= 1.11
Provides:       python-jsonschema-format-nongpl = %{version}-%{release}
Obsoletes:      python-jsonschema-format-nongpl < 4.17.3
Conflicts:      python-jsonschema-format-nongpl >= 4.18

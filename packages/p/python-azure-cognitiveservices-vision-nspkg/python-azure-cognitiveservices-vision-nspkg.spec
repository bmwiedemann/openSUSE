...
Obsoletes:      python3-azure-cognitiveservices-vision-nspkg <= 3.0.1
%endif
BuildArch:      noarch
...
%doc README.rst
%license LICENSE.txt
%{python_sitelib}/azure/cognitiveservices/vision
%{python_sitelib}/azure_cognitiveservices_vision_nspkg-*.dist-info

#
# spec file for package ingress2gateway
#
...
%description
Ingress2gateway helps translate Ingress and provider-specific resources (CRDs)
...
go build \
   -mod=vendor \
   -buildmode=pie \
   -ldflags="-X github.com/kubernetes-sigs/ingress2gateway/pkg/i2gw.Version=v%{version}" \
   -o bin/%{name}

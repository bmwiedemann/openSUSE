...
Name:           enlightenment-theme-cerium2
...
Source:         enlightenment-theme-Cerium2-%{version}.tar.xz
# for convert
...
%prep
%setup -q -n enlightenment-theme-Cerium2-%{version}

%build
./build-darkmod.sh --epkg
cp enlightenment-elementary/Cerium2.edj .
cp licenses-authors/* .

%install
install -m 0755 -d %{buildroot}%{_datadir}/elementary/themes
install -m 0644 -t %{buildroot}%{_datadir}/elementary/themes Cerium2.edj

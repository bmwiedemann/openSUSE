...
Provides:       erlang = %{version}
Conflicts:      otherproviders(erlang)
%if 0%{?rhel} >= 7
...
Provides:       %{_name}-debugger = %{version}
Conflicts:      otherproviders(erlang-debugger)
...
Requires:       %{name}-wx = %{version}
Requires:       graphviz
Provides:       %{_name}-dialyzer = %{version}
Conflicts:      otherproviders(erlang-dialyzer)
...
Conflicts:      otherproviders(erlang-doc)
...
Provides:       %{_name}-epmd = %{version}
Conflicts:      otherproviders(erlang-epmd)
%{sysusers_requires}
...
Requires:       %{name} = %{version}
Requires:       %{name}-wx = %{version}
Provides:       %{_name}-et = %{version}
Conflicts:      otherproviders(erlang-et)
...
Requires:       %{name} = %{version}
Requires:       java >= 1.6.0
Provides:       %{_name}-jinterface = %{version}
Conflicts:      otherproviders(erlang-jinterface)
...
Requires:       %{name} = %{version}
Requires:       %{name}-wx = %{version}
Provides:       %{_name}-reltool = %{version}
Conflicts:      otherproviders(erlang-reltool)
...
Requires:       %{name} = %{version}
Requires:       %{name}-wx = %{version}
Provides:       %{_name}-observer = %{version}
Conflicts:      otherproviders(erlang-observer)
...
Requires:       %{name} = %{version}
Provides:       %{_name}-src = %{version}
Conflicts:      otherproviders(erlang-src)
...
Provides:       %{_name}-debugger-src = %{version}
Conflicts:      otherproviders(erlang-debugger-src)
...
Provides:       %{_name}-dialyzer-src = %{version}
Conflicts:      otherproviders(erlang-dialyzer-src)
...
Provides:       %{_name}-diameter-src = %{version}
Conflicts:      otherproviders(erlang-diameter-src)
...
Provides:       %{_name}-et-src = %{version}
Conflicts:      otherproviders(erlang-et-src)
...
Provides:       %{_name}-jinterface-src = %{version}
Conflicts:      otherproviders(erlang-jinterface-src)
...
Provides:       %{_name}-reltool-src = %{version}
Conflicts:      otherproviders(erlang-reltool-src)
...
Provides:       %{_name}-observer-src = %{version}
Conflicts:      otherproviders(erlang-observer-src)
...
Requires:       %{name}-wx = %{version}
Provides:       %{_name}-wx-src = %{version}
Conflicts:      otherproviders(erlang-wx-src)
...
Provides:       %{_name}-wx = %{version}
Conflicts:      otherproviders(erlang-wx)

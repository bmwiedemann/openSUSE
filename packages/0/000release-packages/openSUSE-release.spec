...
Provides:       product(openSUSE) = 20251010-0
%ifarch x86_64
...
Provides:       product-cpeid() = cpe%3A%2Fo%3Aopensuse%3Aopensuse%3A20251010
...
Provides:       flavor(ftp)
Provides:       product_flavor(openSUSE) = 20251010-0
...
%package -n openSUSE-release-oem
License:        BSD-3-Clause
Group:          System/Fhs
Provides:       product_flavor()
Provides:       flavor(oem)
...
%files oem
%defattr(-,root,root)
%doc %{_defaultdocdir}/openSUSE-release-oem
...
<product schemeversion="0">
  ...
  <name>openSUSE</name>
  <version>20251010</version>
  <release>0</release>
  <arch>%{_target_cpu}</arch>
  <cpeid>cpe:/o:opensuse:opensuse:20251010</cpeid>
...
mkdir -p %{buildroot}%{_defaultdocdir}/openSUSE-release-oem
cat >%{buildroot}%{_defaultdocdir}/openSUSE-release-oem/README << EOF
This package only exists for providing the product flavor 'oem'.

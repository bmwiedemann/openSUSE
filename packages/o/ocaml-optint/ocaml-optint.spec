#
# spec file for package ocaml-optint
#
...
%bcond_with ocaml_optint_testsuite
%define build_flavor @BUILD_FLAVOR@%nil
%if "%build_flavor" == "testsuite"
%if %{without ocaml_optint_testsuite}
...
URL:            https://opam.ocaml.org/packages/optint/
...
BuildRequires:  ocamlfind(monolith)
BuildRequires:  ocamlfind(optint) = %version
%endif

#
# spec file for package ocaml-bin_prot
#
...
URL:            https://opam.ocaml.org/packages/bin_prot
...
BuildRequires:  ocamlfind(base.md5)
BuildRequires:  ocamlfind(bigarray)
BuildRequires:  ocamlfind(ppx_compare)
BuildRequires:  ocamlfind(ppx_custom_printf)
BuildRequires:  ocamlfind(ppx_fields_conv)
BuildRequires:  ocamlfind(ppx_optcomp)
BuildRequires:  ocamlfind(ppx_sexp_conv)
BuildRequires:  ocamlfind(ppx_variants_conv)
%endif

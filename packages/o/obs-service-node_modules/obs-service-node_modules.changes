-------------------------------------------------------------------
Tue Sep 22 12:24:24 UTC 2026 - Adam Majer <adam.majer@suse.de>
...
-------------------------------------------------------------------
Fri Sep 04 11:47:48 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.10:
  * Mark Source*: modifications as legacy
  * Disble output file generation and inline spec processing behind --legacy-container

-------------------------------------------------------------------
Fri Sep 04 09:42:11 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.8:
  * Handle boolean-like values for legacy-container service parameter

-------------------------------------------------------------------
Wed Sep 02 14:58:41 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.7:
  * Include subfolder prefix in generated Source lines if not using obscpio
  * tests: adapt to new git workflow error message
  * Refactor checksum validation and improve diagnostic logging

-------------------------------------------------------------------
Wed Sep 02 14:03:44 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.4:
  * Improve --cpio error message: add Git workflow recommendation

-------------------------------------------------------------------
Wed Sep 02 12:18:50 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.3:
  * Reformat codebase using Ruff
  * Fix directory rename conflicts and add existing files checksum validation

-------------------------------------------------------------------
Wed Sep 02 11:43:12 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.1:
  * Remove files that are no longer part of dependencies on update

-------------------------------------------------------------------
Wed Sep 02 11:00:51 UTC 2026 - Adam Majer <adam.majer@suse.de>

- Update to version 3.0.0:
  * Document directory mode and legacy-container mode in README
  * Add legacy-container and node-dir parameters
  * update poetry deps
  * Document `input` parameter in service file

-------------------------------------------------------------------
Mon Oct 06 15:49:58 UTC 2025 - Adam Majer <adam.majer@suse.de>

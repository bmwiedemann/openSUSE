...
Source:         https://download.kde.org/stable/plasma/5.24.2/discover-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/plasma/5.24.2/discover-%{version}.tar.xz.sig

...
Source:         https://github.com/libyal/libfsfat/releases/download/%version/%name-experimental-%version.tar.gz
#Source2:        https://github.com/libyal/libfsfat/releases/download/%version/%name-experimental-%version.tar.gz.asc

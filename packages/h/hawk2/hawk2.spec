...
Source2:        actioncable-8.1.3.1.gem
Source3:        actionmailbox-8.1.3.1.gem
Source4:        actionmailer-8.1.3.1.gem
Source5:        actionpack-8.1.3.1.gem
Source6:        actiontext-8.1.3.1.gem
Source7:        action_text-trix-2.1.19.gem
Source8:        actionview-8.1.3.1.gem
Source9:        activejob-8.1.3.1.gem
Source10:       activemodel-8.1.3.1.gem
Source11:       activerecord-8.1.3.1.gem
Source12:       activestorage-8.1.3.1.gem
Source13:       activesupport-8.1.3.1.gem
...
Source19:       concurrent-ruby-1.3.8.gem
...
Source34:       gettext_i18n_rails_js-3.1.6.gem
...
Source58:       po_to_json-3.0.6.gem
Source59:       pp-0.6.4.gem
Source60:       prettyprint-0.2.0.gem
Source61:       prime-0.1.4.gem
Source62:       prism-1.9.0.gem
Source63:       puma-8.0.2.gem
Source64:       racc-1.8.1.gem
Source65:       rack-3.2.6.gem
Source66:       rack-session-2.1.2.gem
Source67:       rack-test-2.2.0.gem
Source68:       rackup-2.3.1.gem
Source69:       rails-8.1.3.1.gem
Source70:       rails-dom-testing-2.3.0.gem
Source71:       rails-html-sanitizer-1.7.1.gem
Source72:       railties-8.1.3.1.gem
Source73:       rake-13.4.2.gem
Source74:       rbs-4.1.2.gem
Source75:       rdoc-8.0.0.gem
...
Source83:       sorbet-runtime-0.6.13403.gem
...
Source89:       tilt-2.8.0.gem
Source90:       timeout-0.6.1.gem
...
Source97:       websocket-driver-0.8.2.gem
Source98:       websocket-extensions-0.1.5.gem
Source99:       zeitwerk-2.8.3.gem
...
%verify(not mode) %attr(4750, root, %{gname}) %{_sbindir}/hawk_chkpwd
%dir %{www_base}/hawk
%{www_base}/hawk/log
%{www_base}/hawk/tmp
%{www_base}/hawk/app
...
%exclude %{install_gem_path}/gems/erb-6.0.6/ext/erb/escape/escape.c
%exclude %{install_gem_path}/gems/ffi-1.17.4/ext/ffi_c/*
%exclude %{install_gem_path}/gems/gettext_i18n_rails_js-3.1.6/vendor/bundle/ruby/4.0.0/*
...
%exclude %{install_gem_path}/gems/rbs-4.1.2/ext/*
%exclude %{install_gem_path}/gems/rbs-4.1.2/include/*
%exclude %{install_gem_path}/gems/rbs-4.1.2/src/*
%exclude %{install_gem_path}/gems/rbs-4.1.2/wasm/*
...
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/fbuffer/fbuffer.h
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/generator/generator.c
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/json.h
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/parser/parser.c
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/simd/simd.h
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/vendor/fpconv.c
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/vendor/jeaiii-ltoa.h
%exclude %{install_gem_path}/gems/json-2.21.2/ext/json/ext/vendor/fast_float_parser.h

...
pytest --deselect=tests/test_uploads.py --deselect=tests/test_plugins_cli.py --deselect=tests/test_compress.py --deselect=tests/test_encoding.py --deselect=tests/test_binary.py --deselect=tests/test_cli_ui.py tests -v

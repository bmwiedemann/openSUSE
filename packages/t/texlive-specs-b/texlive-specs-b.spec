...
%config %{_sysconfdir}/fonts/conf.avail/58-texlive-arphic.conf
...
%config %{_sysconfdir}/fonts/conf.avail/58-texlive-arphic-ttf.conf
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source6:        arrayjobx.tar.xz
Source7:        arrayjobx.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source8:        arraysort.tar.xz
Source9:        arraysort.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source10:       arsclassica.tar.xz
Source11:       arsclassica.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source12:       articleingud.tar.xz
Source13:       articleingud.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source14:       arydshln.tar.xz
Source15:       arydshln.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source16:       asaetr.tar.xz
Source17:       asaetr.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source18:       asapsym.tar.xz
Source19:       asapsym.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source22:       ascii-chart.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source23:       ascii-font.tar.xz
Source24:       ascii-font.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source25:       asciilist.tar.xz
Source26:       asciilist.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.2.0hsvn46904
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source27:       ascmac.tar.xz
Source28:       ascmac.doc.tar.xz
...
%config %{_sysconfdir}/fonts/conf.avail/58-texlive-ascmac.conf
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-ascmac-fonts-%{texlive_version}.%{texlive_noarch}.2.0hsvn46904-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source29:       askmaps.tar.xz
Source30:       askmaps.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.03svn50845
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source31:       asmeconf.tar.xz
Source32:       asmeconf.doc.tar.xz

%description -n texlive-asmeconf
This package provides a LaTeX class, a BibTeX style, and a
LaTeX template to format conference papers for the American
Society of Mechanical Engineers (ASME) according to the
requirements on ASME's conference web pages (as posted in March
2019). The .tex and .cls files are commented and should be
self-explanatory. This work is not a publication of ASME
itself.

date: 2019-04-07 04:22:59 +0000
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-asmeconf-%{texlive_version}.%{texlive_noarch}.1.03svn50845-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source33:       aspectratio.tar.xz
Source34:       aspectratio.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source35:       assignment.tar.xz
Source36:       assignment.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source37:       assoccnt.tar.xz
Source38:       assoccnt.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source39:       astro.tar.xz
Source40:       astro.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source41:       asyfig.tar.xz
Source42:       asyfig.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.2.49svn50885
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source43:       asymptote.tar.xz
Source44:       asymptote.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-asymptote-%{texlive_version}.%{texlive_noarch}.2.49svn50885-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source45:       asymptote-by-example-zh-cn.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source46:       asymptote-faq-zh-cn.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source48:       asypictureb.tar.xz
Source49:       asypictureb.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source50:       attachfile.tar.xz
Source51:       attachfile.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.svn41506
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source52:       aucklandthesis.tar.xz
Source53:       aucklandthesis.doc.tar.xz
...
%{_texmfdistdir}/doc/latex/aucklandthesis/aucklandthesis_userguide.pdf
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-aucklandthesis-%{texlive_version}.%{texlive_noarch}.svn41506-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source54:       augie.tar.xz
Source55:       augie.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source56:       auncial-new.tar.xz
Source57:       auncial-new.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source58:       aurical.tar.xz
Source59:       aurical.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source60:       aurl.tar.xz
Source61:       aurl.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source62:       authoraftertitle.tar.xz
Source63:       authoraftertitle.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.0.0svn46704
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source64:       authorarchive.tar.xz
Source65:       authorarchive.doc.tar.xz
...
%{_texmfdistdir}/doc/latex/authorarchive/authorarchive.config
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.bib
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.enw
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.pdf
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.ris
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.tex
%{_texmfdistdir}/doc/latex/authorarchive/brucker-authorarchive-2016.word.xml

%files -n texlive-authorarchive
%defattr(-,root,root,755)
%{_texmfdistdir}/tex/latex/authorarchive/authorarchive.sty
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-authorarchive-%{texlive_version}.%{texlive_noarch}.1.0.0svn46704-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source66:       authorindex.tar.xz
Source67:       authorindex.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source68:       auto-pst-pdf.tar.xz
Source69:       auto-pst-pdf.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.0.0.03svn49364
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source70:       auto-pst-pdf-lua.tar.xz
Source71:       auto-pst-pdf-lua.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-auto-pst-pdf-lua-%{texlive_version}.%{texlive_noarch}.0.0.03svn49364-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source74:       autoarea.tar.xz
Source75:       autoarea.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source76:       autobreak.tar.xz
Source77:       autobreak.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source78:       automata.tar.xz
Source79:       automata.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source80:       autonum.tar.xz
Source81:       autonum.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-autosp-%{texlive_version}.%{texlive_noarch}.svn50602-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source86:       avremu.tar.xz
Source87:       avremu.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.0.0.5svn50757
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source88:       awesomebox.tar.xz
Source89:       awesomebox.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-awesomebox-%{texlive_version}.%{texlive_noarch}.0.0.5svn50757-%{release}-zypper
%endif

%package -n texlive-axodraw2
Version:        %{texlive_version}.%{texlive_noarch}.2.1.1asvn50602
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source90:       axodraw2.tar.xz
Source91:       axodraw2.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-axodraw2-%{texlive_version}.%{texlive_noarch}.2.1.1asvn50602-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source92:       b1encoding.tar.xz
Source93:       b1encoding.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.3.29svn50741
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source94:       babel.tar.xz
Source95:       babel.doc.tar.xz
...
%{_texmfdistdir}/tex/generic/babel/babel-bidi.lua
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-%{texlive_version}.%{texlive_noarch}.3.29svn50741-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source98:       babel-azerbaijani.tar.xz
Source99:       babel-azerbaijani.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source100:      babel-basque.tar.xz
Source101:      babel-basque.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source104:      babel-bosnian.tar.xz
Source105:      babel-bosnian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source106:      babel-breton.tar.xz
Source107:      babel-breton.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source108:      babel-bulgarian.tar.xz
Source109:      babel-bulgarian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source110:      babel-catalan.tar.xz
Source111:      babel-catalan.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source112:      babel-croatian.tar.xz
Source113:      babel-croatian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source114:      babel-czech.tar.xz
Source115:      babel-czech.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source116:      babel-danish.tar.xz
Source117:      babel-danish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source118:      babel-dutch.tar.xz
Source119:      babel-dutch.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source120:      babel-english.tar.xz
Source121:      babel-english.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source122:      babel-esperanto.tar.xz
Source123:      babel-esperanto.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source124:      babel-estonian.tar.xz
Source125:      babel-estonian.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.3qsvn30267
Release:        0
Summary:        Babel/Polyglossia support for Finnish
License:        LPPL-1.0
Group:          Productivity/Publishing/TeX/Base
Url:            http://www.tug.org/texlive/
Requires(pre): texlive >= %{texlive_version}
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source126:      babel-finnish.tar.xz
Source127:      babel-finnish.doc.tar.xz

%description -n texlive-babel-finnish
The package provides a language description file that enables
support of Finnish either with babel or with polyglossia.
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-finnish-%{texlive_version}.%{texlive_noarch}.1.3qsvn30267-%{release}-zypper
%endif

%package -n texlive-babel-french
Version:        %{texlive_version}.%{texlive_noarch}.3.5esvn50711
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source128:      babel-french.tar.xz
Source129:      babel-french.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-french-%{texlive_version}.%{texlive_noarch}.3.5esvn50711-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source130:      babel-friulan.tar.xz
Source131:      babel-friulan.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source132:      babel-galician.tar.xz
Source133:      babel-galician.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source134:      babel-georgian.tar.xz
Source135:      babel-georgian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source136:      babel-german.tar.xz
Source137:      babel-german.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.9gsvn42010
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source138:      babel-greek.tar.xz
Source139:      babel-greek.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-greek-%{texlive_version}.%{texlive_noarch}.1.9gsvn42010-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source140:      babel-hebrew.tar.xz
Source141:      babel-hebrew.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source142:      babel-hungarian.tar.xz
Source143:      babel-hungarian.doc.tar.xz

%description -n texlive-babel-hungarian
The package provides a language definition file that enables
support of Magyar (Hungarian) with babel.

date: 2019-01-14 16:57:57 +0000
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source144:      babel-icelandic.tar.xz
Source145:      babel-icelandic.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source146:      babel-indonesian.tar.xz
Source147:      babel-indonesian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source148:      babel-interlingua.tar.xz
Source149:      babel-interlingua.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source150:      babel-irish.tar.xz
Source151:      babel-irish.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.4.01svn49606
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source152:      babel-italian.tar.xz
Source153:      babel-italian.doc.tar.xz

%description -n texlive-babel-italian
The package provides language definitions for use in babel.

date: 2019-01-05 19:06:26 +0000
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-italian-%{texlive_version}.%{texlive_noarch}.1.4.01svn49606-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source154:      babel-japanese.tar.xz
Source155:      babel-japanese.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source156:      babel-kurmanji.tar.xz
Source157:      babel-kurmanji.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source158:      babel-latin.tar.xz
Source159:      babel-latin.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source160:      babel-latvian.tar.xz
Source161:      babel-latvian.doc.tar.xz

%description -n texlive-babel-latvian
The package provides the language definition file for support
of Latvian in babel.

date: 2018-02-19 16:17:15 +0000
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source162:      babel-macedonian.tar.xz
Source163:      babel-macedonian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source164:      babel-malay.tar.xz
Source165:      babel-malay.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source166:      babel-norsk.tar.xz
Source167:      babel-norsk.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source168:      babel-occitan.tar.xz
Source169:      babel-occitan.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source170:      babel-piedmontese.tar.xz
Source171:      babel-piedmontese.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source172:      babel-polish.tar.xz
Source173:      babel-polish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source174:      babel-portuges.tar.xz
Source175:      babel-portuges.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source176:      babel-romanian.tar.xz
Source177:      babel-romanian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source178:      babel-romansh.tar.xz
Source179:      babel-romansh.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source180:      babel-russian.tar.xz
Source181:      babel-russian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source182:      babel-samin.tar.xz
Source183:      babel-samin.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source184:      babel-scottish.tar.xz
Source185:      babel-scottish.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.0dsvn30290
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source186:      babel-serbian.tar.xz
Source187:      babel-serbian.doc.tar.xz

%description -n texlive-babel-serbian
The package provides a language description file that enables
support of Serbian either with babel or with polyglossia.
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-serbian-%{texlive_version}.%{texlive_noarch}.1.0dsvn30290-%{release}-zypper
%endif

%package -n texlive-babel-serbianc
Version:        %{texlive_version}.%{texlive_noarch}.3.0svn49693
Release:        0
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-babel-serbianc-%{texlive_version}.%{texlive_noarch}.3.0svn49693-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source190:      babel-slovak.tar.xz
Source191:      babel-slovak.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source192:      babel-slovenian.tar.xz
Source193:      babel-slovenian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source194:      babel-sorbian.tar.xz
Source195:      babel-sorbian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source196:      babel-spanglish.tar.xz
Source197:      babel-spanglish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source198:      babel-spanish.tar.xz
Source199:      babel-spanish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source200:      babel-swedish.tar.xz
Source201:      babel-swedish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source202:      babel-thai.tar.xz
Source203:      babel-thai.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source204:      babel-turkish.tar.xz
Source205:      babel-turkish.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source206:      babel-ukrainian.tar.xz
Source207:      babel-ukrainian.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source208:      babel-vietnamese.tar.xz
Source209:      babel-vietnamese.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source210:      babel-welsh.tar.xz
Source211:      babel-welsh.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source212:      babelbib.tar.xz
Source213:      babelbib.doc.tar.xz
...
Source215:      background.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source216:      backnaur.tar.xz
Source217:      backnaur.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source218:      baekmuk.tar.xz
Source219:      baekmuk.doc.tar.xz
...
%config %{_sysconfdir}/fonts/conf.avail/58-texlive-baekmuk.conf
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source220:      bagpipe.tar.xz
Source221:      bagpipe.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source222:      bangorcsthesis.tar.xz
Source223:      bangorcsthesis.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source224:      bangorexam.tar.xz
Source225:      bangorexam.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source226:      bangtex.tar.xz
Source227:      bangtex.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source228:      bankstatement.tar.xz
Source229:      bankstatement.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source230:      barcodes.tar.xz
Source231:      barcodes.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source234:      barr.tar.xz
Source235:      barr.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source236:      bartel-chess-fonts.tar.xz
Source237:      bartel-chess-fonts.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source238:      bashful.tar.xz
Source239:      bashful.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source240:      basicarith.tar.xz
Source241:      basicarith.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source242:      baskervald.tar.xz
Source243:      baskervald.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.1.072svn43461
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source244:      baskervaldx.tar.xz
Source245:      baskervaldx.doc.tar.xz
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-baskervaldx-fonts-%{texlive_version}.%{texlive_noarch}.1.072svn43461-%{release}-zypper
%endif

%package -n texlive-baskervillef
Version:        %{texlive_version}.%{texlive_noarch}.1.046svn49084
Release:        0
...
Provides:       tex(zba_23u2ky.enc)
Provides:       tex(zba_3ftlum.enc)
Provides:       tex(zba_3oppw2.enc)
Provides:       tex(zba_4ccljp.enc)
...
Provides:       tex(zba_aaxxgg.enc)
Provides:       tex(zba_ahcsm7.enc)
Provides:       tex(zba_akd6xg.enc)
Provides:       tex(zba_ao5ma2.enc)
Provides:       tex(zba_aoxy5h.enc)
Provides:       tex(zba_aqsbza.enc)
Provides:       tex(zba_avwth5.enc)
Provides:       tex(zba_bue3wb.enc)
Provides:       tex(zba_c63ir2.enc)
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source246:      baskervillef.tar.xz
Source247:      baskervillef.doc.tar.xz
...
%defattr(-,root,root,755)
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_23u2ky.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_3ftlum.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_3oppw2.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_4ccljp.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_aaxxgg.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ahcsm7.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_akd6xg.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ao5ma2.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_aoxy5h.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_aqsbza.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_avwth5.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_bue3wb.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_c63ir2.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ehpynd.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_fcs4fj.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_fubxud.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ia2mtc.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_jets2w.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_mn5dh2.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_nslu6t.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_nuqukl.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_oz4czd.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_pjh6nq.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_pl4uwu.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_pqfamk.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_q6x5np.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_qycpdj.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_r53rzo.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_r6vf4u.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_rqwz3b.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_rytc7q.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_sb5wfb.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_srcuqk.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_svqttf.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_twsbyo.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_uf7ozb.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ulzhd3.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_uueufy.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_ve4agh.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_vezlo5.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_vhcnqo.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_vunabj.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_w3yfya.enc
...
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_wsb4vu.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_wzpsw2.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_xlbenp.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_xtbuvi.enc
%{_texmfdistdir}/fonts/enc/dvips/baskervillef/zba_y2t5aj.enc
...
%config %{_sysconfdir}/fonts/conf.avail/58-texlive-baskervillef.conf
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-baskervillef-fonts-%{texlive_version}.%{texlive_noarch}.1.046svn49084-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source248:      basque-book.tar.xz
Source249:      basque-book.doc.tar.xz
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source250:      basque-date.tar.xz
Source251:      basque-date.doc.tar.xz
...
Version:        %{texlive_version}.%{texlive_noarch}.2.0svn47507
Release:        0
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source252:      bath-bst.tar.xz
Source253:      bath-bst.doc.tar.xz
...
%defattr(-,root,root,755)
%{_texmfdistdir}/doc/bibtex/bath-bst/Makefile
...
%if %{with zypper_posttrans}
/var/adm/update-scripts/texlive-bath-bst-%{texlive_version}.%{texlive_noarch}.2.0svn47507-%{release}-zypper
%endif
...
# Download at ftp://ftp.ctan.org/pub/tex/systems/texlive/tlnet/archive/
# from 20190407
Source254:      bbcard.tar.xz
Source255:      bbcard.doc.tar.xz
...
%endif
    ...
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.avail/58-texlive-arphic.conf)<<-'EOF'
	<?xml version="1.0"?>
...
%endif
    ...
    mkdir -p %{buildroot}%{_sysconfdir}/fonts/conf.avail
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.avail/58-texlive-arphic-ttf.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-ascmac-fonts-%{texlive_version}.%{texlive_noarch}.2.0hsvn46904-%{release}-zypper
%endif
    ...
    mkdir -p %{buildroot}%{_sysconfdir}/fonts/conf.avail
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.avail/58-texlive-ascmac.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-asmeconf-%{texlive_version}.%{texlive_noarch}.1.03svn50845-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-asymptote-%{texlive_version}.%{texlive_noarch}.2.49svn50885-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-aucklandthesis-%{texlive_version}.%{texlive_noarch}.svn41506-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-authorarchive-%{texlive_version}.%{texlive_noarch}.1.0.0svn46704-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-auto-pst-pdf-lua-%{texlive_version}.%{texlive_noarch}.0.0.03svn49364-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-autosp-%{texlive_version}.%{texlive_noarch}.svn50602-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-awesomebox-%{texlive_version}.%{texlive_noarch}.0.0.5svn50757-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-axodraw2-%{texlive_version}.%{texlive_noarch}.2.1.1asvn50602-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-%{texlive_version}.%{texlive_noarch}.3.29svn50741-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-finnish-%{texlive_version}.%{texlive_noarch}.1.3qsvn30267-%{release}-zypper
%endif
    tar --use-compress-program=xz -xf %{S:126} -C %{buildroot}%{_datadir}/texlive/texmf-dist
    tar --use-compress-program=xz -xf %{S:127} -C %{buildroot}%{_datadir}/texlive/texmf-dist
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-french-%{texlive_version}.%{texlive_noarch}.3.5esvn50711-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-greek-%{texlive_version}.%{texlive_noarch}.1.9gsvn42010-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-italian-%{texlive_version}.%{texlive_noarch}.1.4.01svn49606-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-serbian-%{texlive_version}.%{texlive_noarch}.1.0dsvn30290-%{release}-zypper
%endif
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-babel-serbianc-%{texlive_version}.%{texlive_noarch}.3.0svn49693-%{release}-zypper
%endif
...
%endif
    ...
    mkdir -p %{buildroot}%{_sysconfdir}/fonts/conf.avail
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.avail/58-texlive-baekmuk.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-baskervaldx-fonts-%{texlive_version}.%{texlive_noarch}.1.072svn43461-%{release}-zypper
%endif
    ...
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.d/55-texlive-baskervaldx.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-baskervillef-fonts-%{texlive_version}.%{texlive_noarch}.1.046svn49084-%{release}-zypper
%endif
    ...
    mkdir -p %{buildroot}%{_sysconfdir}/fonts/conf.avail
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.avail/58-texlive-baskervillef.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
    ...
    mkdir -p %{buildroot}%{_sysconfdir}/fonts/conf.d
    (cat > %{buildroot}%{_sysconfdir}/fonts/conf.d/55-texlive-baskervillef.conf)<<-'EOF'
	<?xml version="1.0"?>
	<!DOCTYPE fontconfig SYSTEM "fonts.dtd">
...
%if %{with zypper_posttrans}
    ln -sf %{_texmfdistdir}/texconfig/zypper.py \
       %{buildroot}/var/adm/update-scripts/texlive-bath-bst-%{texlive_version}.%{texlive_noarch}.2.0svn47507-%{release}-zypper
%endif

...
# PATCH-FIX-UPSTREAM 0001-fix-unescaped-curly-brace-in-regex-and-invert-query-.patch
...
Patch1:         0001-fix-unescaped-curly-brace-in-regex-and-invert-query-.patch

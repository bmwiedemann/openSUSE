#
# spec file for package tree-sitter-diff
#
...
Version:        0.2.0
Release:        0
Summary:        Diff grammar for tree-sitter
License:        MIT
...
%description
The tree-sitter grammar for unified diffs and patches, as a shared
library, a WebAssembly module and the grammar's own queries.

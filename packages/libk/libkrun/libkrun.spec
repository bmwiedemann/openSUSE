...
# For handling the transition from old versions of the packages (can probably be removed...)
...
Provides:       %{name}:%{_libdir}/libkrun.so
...
Requires:       libkrunfw-sev5
Obsoletes:      libkrun-sev <= 1.4.1

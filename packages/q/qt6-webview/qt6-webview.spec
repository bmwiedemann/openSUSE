...
%post -n libQt6WebView6 -p /sbin/ldconfig
%postun -n libQt6WebView6 -p /sbin/ldconfig
%post -n libQt6WebViewQuick6 -p /sbin/ldconfig
%postun -n libQt6WebViewQuick6 -p /sbin/ldconfig

...
Patch3:         assert.patch
# PATCH-FIX-UPSTREAM - fix linking with system audaspace
Patch4:         daf9b2ba60305497684412bf864e7de2f9a467e3.patch
...
BuildRequires:  gcc%{?force_gcc_version}-c++ >= 14
...
BuildRequires:  openvdb-devel >= 13
...
BuildRequires:  pkgconfig(audaspace) >= 1.9.0

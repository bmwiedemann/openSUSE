...
Source0:        https://download.kde.org/stable/massif-visualizer/%{version}/src/%{name}-%{version}.tar.xz
%if %{with released}
Source1:        https://download.kde.org/stable/massif-visualizer/%{version}/src/%{name}-%{version}.tar.xz.sig
Source2:        massif-visualizer.keyring
%endif

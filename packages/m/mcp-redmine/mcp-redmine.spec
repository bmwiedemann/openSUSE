#
# spec file for package mcp-redmine
#
...
# PATCH-FIX-OPENSUSE mcp-redmine-fastmcp-1.x.patch mpluskal@suse.com -- Factory python-mcp is still 1.28 FastMCP
Patch0:         mcp-redmine-fastmcp-1.x.patch
...
# Renamed from redmine-mcp to match upstream, which calls the project,
# the sdist, the Python module and the installed binary all "mcp-redmine"
Provides:       redmine-mcp = %{version}-%{release}
Obsoletes:      redmine-mcp < %{version}-%{release}
BuildArch:      noarch

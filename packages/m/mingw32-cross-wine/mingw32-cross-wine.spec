...
%_mingw32_create_macro_links mingw32-cross-wine-init
%_mingw32_create_macro_links mingw32-cross-wine-run
%_mingw32_create_macro_links mingw32-cross-wine-start-session

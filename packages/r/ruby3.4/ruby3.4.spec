...
%global rb_binary_suffix .ruby3.4
%global rb_soname ruby3.4
%global _rb_ua_weight 34

# ruby-macros and ruby-common version
%global rpm_macros_version 3

#
%define libname libruby3_4-3_4
...
Source:         https://cache.ruby-lang.org/pub/ruby/3.4/ruby-%{pkg_version}.tar.xz
...
install -D -m 0644 %{SOURCE3} %{buildroot}%{_rpmmacrodir}/macros.suse-ruby3.4
mkdir -p %{buildroot}%{_sysconfdir}/alternatives
%if 0%{?is_default_ruby}
  install -D -m 0644 %{SOURCE4} %{buildroot}%{_rpmmacrodir}/macros.suse-ruby3.4-default
...
%{_rpmmacrodir}/macros.suse-ruby3.4*

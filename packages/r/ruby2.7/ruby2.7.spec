...
install -D -m 0644 %{S:3} %{buildroot}%{_rpmmacrodir}/macros.suse-ruby2.7
mkdir -p %{buildroot}%{_sysconfdir}/alternatives
%if 0%{?is_default_ruby}
  install -D -m 0644 %{S:4} %{buildroot}%{_rpmmacrodir}/macros.suse-ruby2.7-default
...
%{_rpmmacrodir}/macros.suse-ruby2.7*

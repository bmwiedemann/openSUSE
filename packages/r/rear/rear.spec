...
# to the ReaR upstream version (e.g. "Version: 2.9.a")
...
# At GitHub rear/rear the "ReaR 2.9 release" commit
# https://github.com/rear/rear/commit/e89f78abc92c264647068fe540a40d349d8a5671
# is tagged both 'rear-2.9' and '2.9'
# see https://github.com/rear/rear/tags,
# To achieve a tarball file name rear-2.9.tar.gz when downloading Source0 works by using the download URL
# https://github.com/rear/rear/archive/2.9/rear-2.9.tar.gz
# because the part after the last slash is entirely arbitrary
# so one can have the file named as one wants
# see https://github.com/rear/rear/pull/3389#issuecomment-2632131305
# for example via
# wget https://github.com/rear/rear/archive/2.9/rear-2.9.tar.gz
...
# ReaR calls "lsb_release" as last resource in /usr/share/rear/lib/config-functions.sh
...
Requires:       iproute2
Requires:       iputils
# ReaR calls openssl in /usr/share/rear/rescue/default/500_ssh.sh
Requires:       openssl
...
# that runs "bash -n" for all bash files to test if the plain syntax is OK
make validate
...
%files
%defattr(-,root,root,-)
%doc MAINTAINERS COPYING README.md doc/*.txt doc/*.adoc doc/user-guide/*.adoc doc/mappings/
%{_mandir}/man8/rear.8*

#
# spec file for package rubygem-http-form_data
#
...
%define mod_name http-form_data
...
find %{buildroot}/%{_libdir}/ruby/gems/ \( -name '.rubocop.yml' -o -name '.travis.yml' -o -name '.yardopts' -o -name '.rspec' -o -name '.gitignore' -o -name '.editorconfig' \) | xargs rm -rf
# /MANUAL

...
%bcond_with    bootstrap_from_git

#
URL:            https://www.ruby-lang.org/
Source:         https://cache.ruby-lang.org/pub/ruby/4.0/ruby-%{pkg_version}.tar.xz
...
%configure \
  %if %{with bootstrap_from_git}
  --with-baseruby=%{_bindir}/ruby.ruby3.3 \
  %endif
  %if %{with yjit}
  --enable-yjit \
  %endif
...
%ghost %{_sysconfdir}/alternatives/test-unit

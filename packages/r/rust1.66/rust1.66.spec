...
%global version_previous 1.65.0
...
if [ ! -f %{buildroot}%{_libexecdir}/rust-analyzer-proc-macro-srv ] &&
   [ -f %{buildroot}%{_exec_prefix}/libexec/rust-analyzer-proc-macro-srv ]; then
    mv %{buildroot}%{_exec_prefix}/libexec/rust-analyzer-proc-macro-srv \
    %{buildroot}%{_libexecdir}/rust-analyzer-proc-macro-srv
fi

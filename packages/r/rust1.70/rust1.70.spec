...
%global version_previous 1.69.0
...
%ifarch aarch64
python3 ./x.py test --target=%{rust_triple} --exclude tests/run-make/issue-71519,src/tools/tidy,tests/ui/methods/,tests/ui/typeck,tests/ui/mismatched_types,src/bootstrap
%else
python3 ./x.py test --target=%{rust_triple} --exclude src/tools/tidy,tests/ui/methods/,tests/ui/typeck,tests/ui/mismatched_types,src/bootstrap
%endif

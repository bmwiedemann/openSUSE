...
Provides:       libretro-mednafen-wswan
Obsoletes:      libretro-mednafen-wswan
...
cp mednafen_wswan_libretro.so %{buildroot}%{_libdir}/libretro

%files
%dir %{_libdir}/libretro
%{_libdir}/libretro/mednafen_wswan_libretro.so

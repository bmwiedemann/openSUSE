...
%description
Jenkins X provides automated CI+CD for Kubernetes with Preview Environments on
...
go build \
   ...
   -X github.com/jenkins-x/jx/pkg/cmd/version.Revision=${COMMIT_HASH:0:8} \
   -X github.com/jenkins-x/jx/pkg/cmd/version.Branch=v%{version} \
   -X github.com/jenkins-x/jx/pkg/cmd/version.GitTreeState=clean \
   -X github.com/jenkins-x/jx/pkg/cmd/version.GoVersion=${GO_VERSION} \
   -X github.com/jenkins-x/jx/pkg/cmd/version.BuildDate=${BUILD_DATE}" \

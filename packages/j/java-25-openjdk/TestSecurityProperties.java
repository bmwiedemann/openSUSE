...
public class TestSecurityProperties {
    ...
    // Omit JAVA_HOME + "/conf/security/crypto-policies.properties" which simply includes
    // true/crypto-policies.properties in case system.crypto-policies is left undefined.
 ...
 * && (/usr/lib/jvm/java-25-openjdk/bin/java -Dsystem.crypto-policies=true  TestSecurityProperties false ; [[ $? == 1 ]]) \
 * && (/usr/lib/jvm/java-25-openjdk/bin/java -Dsystem.crypto-policies=false TestSecurityProperties true  ; [[ $? == 1 ]]) \
 * &&  /usr/lib/jvm/java-25-openjdk/bin/java                                TestSecurityProperties true                   \
 * &&  /usr/lib/jvm/java-25-openjdk/bin/java -Dsystem.crypto-policies=true  TestSecurityProperties true                   \
 * &&  /usr/lib/jvm/java-25-openjdk/bin/java -Dsystem.crypto-policies=false TestSecurityProperties false"                 \
 * fill-column: 124
 * End:
 */

#
# spec file for package libgnome-games-support1_3
#
...
Name:           libgnome-games-support1_3
Version:        1.8.2
Release:        0
...
Source0:        https://download.gnome.org/sources/libgnome-games-support/1.8/%{_name}-%{version}.tar.xz
Source1:        https://download.gnome.org/sources/libgnome-games-support/1.8/%{_name}-%{version}.sha256sum

...
License:        MIT
Group:          System/Base
Source0:        default-MicroOS.preset
Source1:        default-MicroOS-user.preset
...
install -Dm0644 %{SOURCE0}  %{buildroot}%{_prefix}/lib/systemd/system-preset/87-default-MicroOS.preset
install -Dm0644 %{SOURCE1}  %{buildroot}%{_prefix}/lib/systemd/user-preset/87-default-MicroOS-user.preset
...
%{_prefix}/lib/systemd/user-preset/87-default-MicroOS-user.preset

...
%global version 3.53.2.0
%global amalgamation_version 3530200
...
Source1:        https://sqlite.org/2026/sqlite-amalgamation-%{amalgamation_version}.zip
...
%build
%make_build native ENABLE_UPDATE_DELETE_LIMIT=0
%{mvn_build} -f -- \
    -Dsource=8

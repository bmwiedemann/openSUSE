#
# spec file for package cross-arm-none-gcc16-bootstrap
#
...
%define pkgname cross-arm-none-gcc16-bootstrap
...
%description -n cross-amdgcn-newlib16-devel
...
%{_sbindir}/update-alternatives \
  --install %{_bindir}/%{gcc_target_arch}-gcc %{gcc_target_arch}-gcc %{_bindir}/%{gcc_target_arch}-gcc%{binsuffix} 16 \
...
%if 0%{?nvptx_newlib:1}
%files -n cross-nvptx-newlib16-devel
%defattr(-,root,root)
%{_prefix}/%{gcc_target_arch}
%endif

%if 0%{?amdgcn_newlib:1}
%files -n cross-amdgcn-newlib16-devel
%defattr(-,root,root)
%{_prefix}/%{gcc_target_arch}

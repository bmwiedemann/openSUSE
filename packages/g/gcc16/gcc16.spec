...
# rust now requires cargo to build, disable it by default
%bcond_with gcc_rust
...
%define build_rust %{with gcc_rust}
%endif
%endif
...
%define libgo_sover 25
%define libgphobos_sover 7
%define libgdruntime_sover 7
%define libgccjit_sover 0
%define libm2_sover 21
%define libgcobol_sover 2
%define libga68_sover 2
...
%define itsme16 1
%define plv_ %{!?product_libs_gcc_ver:16}%{?product_libs_gcc_ver}
%define plv() %{expand:%%{!?itsme%{expand:%%{!?product_libs_gcc_ver_%{1}%{2}:%%{plv_}}%%{?product_libs_gcc_ver_%{1}%{2}}}:-gcc16}}
...
%define libga68_suffix %{plv libga68 %{libga68_sover}}
...
%if %{build_ada}
%if 0%{?gcc_version:%{gcc_version}} > 16
...
%endif
%if %{build_nvptx}
BuildRequires:  cross-nvptx-gcc16
BuildRequires:  cross-nvptx-newlib16-devel
%endif
%if %{build_gcn}
BuildRequires:  cross-amdgcn-gcc16
BuildRequires:  cross-amdgcn-newlib16-devel
%endif
%endif
%if %{build_rust}
# FIXME
...
%endif
Suggests:       gcc16-info gcc16-locale
%endif

Group:          Development/Languages/C and C++
Source:         gcc-%{version}.tar.xz
Source1:        change_spec
Source2:        gcc16-rpmlintrc
Source3:        gcc16-testresults-rpmlintrc
Source4:        README.First-for.SuSE.packagers
Source5:        newlib-4.6.0.20260123.tar.xz
...
License:        GPL-3.0-or-later
Group:          Development/Languages/C and C++
Requires:       gcc16-32bit = %{version}-%{release}
Requires:       gcc16-c++ = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/C and C++
Requires:       gcc16-64bit = %{version}-%{release}
Requires:       gcc16-c++ = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc16-c++-32bit = %{version}-%{release}
Requires:       gcc16-obj-c++ = %{version}-%{release}
Requires:       gcc16-objc-32bit = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc16-c++-64bit = %{version}-%{release}
Requires:       gcc16-obj-c++ = %{version}-%{release}
Requires:       gcc16-objc-64bit = %{version}-%{release}
...
Requires:       libada16 = %{version}-%{release}
...
Requires:       gcc16-32bit = %{version}-%{release}
Requires:       gcc16-ada = %{version}-%{release}
Requires:       libada16-32bit = %{version}-%{release}
...
Requires:       gcc16-64bit = %{version}-%{release}
Requires:       gcc16-ada = %{version}-%{release}
Requires:       libada16-64bit = %{version}-%{release}
...
License:        GPL-3.0-or-later WITH GCC-exception-3.1
Group:          System/Libraries
Provides:       libgnarl-16 = %{version}-%{release}
Conflicts:      libgnarl-16
Provides:       libgnat-16 = %{version}-%{release}
Conflicts:      libgnat-16

%description -n libada16
...
%post -n libada16 -p /sbin/ldconfig

%postun -n libada16 -p /sbin/ldconfig

%package -n libada16-32bit
Summary:        GNU Ada Runtime Libraries
License:        GPL-3.0-or-later WITH GCC-exception-3.1
Group:          System/Libraries
Provides:       libgnarl-16-32bit = %{version}-%{release}
Conflicts:      libgnarl-16-32bit
Provides:       libgnat-16-32bit = %{version}-%{release}
Conflicts:      libgnat-16-32bit

%description -n libada16-32bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada16-32bit -p /sbin/ldconfig

%postun -n libada16-32bit -p /sbin/ldconfig

%package -n libada16-64bit
Summary:        GNU Ada Runtime Libraries
License:        GPL-3.0-or-later WITH GCC-exception-3.1
Group:          System/Libraries
Provides:       libgnarl-16-64bit = %{version}-%{release}
Conflicts:      libgnarl-16-64bit
Provides:       libgnat-16-64bit = %{version}-%{release}
Conflicts:      libgnat-16-64bit

%description -n libada16-64bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada16-64bit -p /sbin/ldconfig

%postun -n libada16-64bit -p /sbin/ldconfig
...
Group:          Development/Languages/Other
Requires:       gcc16 = %{version}-%{release}
Requires:       gcc16-cobol = %{version}-%{release}
...
Group:          Development/Languages/Other
Requires:       gcc16 = %{version}-%{release}
Requires:       gcc16-algol68 = %{version}-%{release}
Requires:       libga68-%{libga68_sover} >= %{version}-%{release}

%description algol68
This package contains an Algol 68 compiler.

%package algol68-32bit
Summary:        GNU GCC Algol 68 Compiler
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc16-32bit = %{version}-%{release}
Requires:       gcc16-algol68 = %{version}-%{release}
Requires:       libga68-%{libga68_sover}-32bit >= %{version}-%{release}

%description algol68-32bit
This package contains an Algol 68 compiler.

%package algol68-64bit
Summary:        GNU GCC Algol 68 Compiler
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc16-64bit = %{version}-%{release}
Requires:       gcc16-algol68 = %{version}-%{release}
Requires:       libga68-%{libga68_sover}-64bit >= %{version}-%{release}

%description algol68-64bit
This package contains an Algol 68 compiler.

%package -n libga68-%{libga68_sover}%{libga68_suffix}
Summary:        GNU GCC Algol 68 compiler runtime library
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Provides:       libga68-%{libga68_sover} = %{version}-%{release}
# Only one package may provide this - allows multiple gcc versions
# to co-exist without an overly large list of provides/obsoletes
Conflicts:      libga68-%{libga68_sover}

%description -n libga68-%{libga68_sover}%{libga68_suffix}
Runtime library for the GNU GCC Algol 68 language.

%post -n libga68-%{libga68_sover}%{libga68_suffix} -p /sbin/ldconfig

%postun -n libga68-%{libga68_sover}%{libga68_suffix} -p /sbin/ldconfig

%package -n libga68-%{libga68_sover}%{libga68_suffix}-32bit
Summary:        GNU GCC Algol 68 compiler runtime library
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Provides:       libga68-%{libga68_sover}-32bit = %{version}-%{release}
# Only one package may provide this - allows multiple gcc versions
# to co-exist without an overly large list of provides/obsoletes
Conflicts:      libga68-%{libga68_sover}-32bit

%description -n libga68-%{libga68_sover}%{libga68_suffix}-32bit
Runtime library for the GNU GCC Algol 68 language.

%post -n libga68-%{libga68_sover}%{libga68_suffix}-32bit -p /sbin/ldconfig

%postun -n libga68-%{libga68_sover}%{libga68_suffix}-32bit -p /sbin/ldconfig

%package -n libga68-%{libga68_sover}%{libga68_suffix}-64bit
Summary:        GNU GCC Algol 68 compiler runtime library
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Provides:       libga68-%{libga68_sover}-64bit = %{version}-%{release}
# Only one package may provide this - allows multiple gcc versions
# to co-exist without an overly large list of provides/obsoletes
Conflicts:      libga68-%{libga68_sover}-64bit

%description -n libga68-%{libga68_sover}%{libga68_suffix}-64bit
Runtime library for the GNU GCC Algol 68 language.

%post -n libga68-%{libga68_sover}%{libga68_suffix}-64bit -p /sbin/ldconfig

%postun -n libga68-%{libga68_sover}%{libga68_suffix}-64bit -p /sbin/ldconfig
...
ln -s newlib-4.6.0.20260123/newlib .
%else
...
%patch -p1 -P 19
# For SLE15 and earlier make _Unwind_Find_FDE dynamically detec
# newer glibc _dl_find_object
%patch -p1 -P 20
%endif
%patch -p1 -P 22
%patch -P 51
...
ln -s /usr/bin/llvm-objdump-%{product_libs_llvm_ver}* target-tools/bin/amdgcn-amdhsa-objdump
...
export ALT_CC_UNDER_TEST=/usr/bin/gcc
export ALT_CXX_UNDER_TEST=/usr/bin/g++
...
for lib in libobjc libgfortran libquadmath libcaf_single libcaf_shmem \
...
mv %{buildroot}/%{_lib}/libgcc_s_asneeded.so %{buildroot}/%{versmainlibdir}/
%if 0%{?usrmerged}
...
mv %{buildroot}/lib/libgcc_s_asneeded.so %{buildroot}/%{versmainlibdirbi32}/
...
mv %{buildroot}/lib64/libgcc_s_asneeded.so %{buildroot}/%{versmainlibdirbi64}/
...
%endif
%if %{build_algol68}
mv %{buildroot}%{_infodir}/ga68.info %{buildroot}%{_infodir}/ga68%{binsuffix}.info
mv %{buildroot}%{_infodir}/ga68-internals.info %{buildroot}%{_infodir}/ga68-internals%{binsuffix}.info
mv %{buildroot}%{_infodir}/ga68-coding-guidelines.info %{buildroot}%{_infodir}/ga68-coding-guidelines%{binsuffix}.info
%endif
...
%find_lang libstdc++
cat cpplib%{binsuffix}.lang gcc%{binsuffix}.lang > gcc16-locale.lang
...
%endif
%if %{build_algol68}
%install_info --info-dir=%{_infodir} %{_infodir}/ga68%{binsuffix}.info.gz
%install_info --info-dir=%{_infodir} %{_infodir}/ga68-internals%{binsuffix}.info.gz
%install_info --info-dir=%{_infodir} %{_infodir}/ga68-coding-guidelines%{binsuffix}.info.gz
%endif
...
%{libsubdir}/include/arm_private_fp8.h
%{libsubdir}/include/arm_private_neon_types.h
%endif
%ifarch riscv64
...
%versmainlib libatomic_asneeded.so
%versmainlib libatomic_asneeded.a
%endif
%ifarch %asan_arch
...
%if %{separate_biarch}
%files -n gcc16%{separate_biarch_suffix}
%defattr(-,root,root)
%versbiarchlib *crt*.o
...
%versbiarchlib libatomic_asneeded.a
%versbiarchlib libatomic_asneeded.so
%endif
%ifarch %asan_arch
...
%files locale -f gcc16-locale.lang
...
%endif
%if %{build_algol68}
%doc %{_infodir}/ga68%{binsuffix}.info*gz
%doc %{_infodir}/ga68-internals%{binsuffix}.info*gz
%doc %{_infodir}/ga68-coding-guidelines%{binsuffix}.info*gz
%endif
...
%if %{separate_biarch}
%files -n libada16%{separate_biarch_suffix}
%defattr(-,root,root)
...
%files algol68
%defattr(-,root,root)
%{_prefix}/bin/ga68%{binsuffix}
%{libsubdir}/a681
%versmainlib libga68.a
%versmainlib libga68.so
%versmainlib libga68.spec
%doc %{_mandir}/man1/ga68%{binsuffix}.1.gz

%if %{separate_biarch}
%files algol68%{separate_biarch_suffix}
%defattr(-,root,root)
%versbiarchlib libga68.a
%versbiarchlib libga68.so
%versbiarchlib libga68.spec
%endif

%files -n libga68-%{libga68_sover}%{libga68_suffix}
%defattr(-,root,root)
%mainlib libga68.so.%{libga68_sover}*

%if %{separate_biarch}
%files -n libga68-%{libga68_sover}%{libga68_suffix}%{separate_biarch_suffix}
%defattr(-,root,root)
%biarchlib libga68.so.%{libga68_sover}*
%endif
%endif

%if 0%{?run_tests:1}
%files -n gcc16-testresults
%defattr(-,root,root)

...
Source0:        https://download.savannah.gnu.org/releases/gsequencer/8.0.x/%{name}-%{version}.tar.gz
...
%package -n typelib-1_0-Libags-8_0
Summary:        Introspection bindings for GSequencer's core libraries
Group:          System/Libraries

%description -n typelib-1_0-Libags-8_0
Advanced Gtk+ Sequencer is an audio sequencer application.
...
%files -n typelib-1_0-Libags-8_0
%{_libdir}/girepository-1.0/Ags-8.0.typelib
%{_libdir}/girepository-1.0/AgsGui-8.0.typelib
%{_libdir}/girepository-1.0/AgsAudio-8.0.typelib

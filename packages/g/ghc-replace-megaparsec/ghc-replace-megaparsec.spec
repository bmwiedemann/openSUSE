#
# spec file for package ghc-replace-megaparsec
#
...
%global pkg_name replace-megaparsec
%global pkgver %{pkg_name}-%{version}
%bcond_with tests
Name:           ghc-%{pkg_name}
Version:        1.5.0.1
Release:        0
Summary:        Find, replace, split string patterns with Megaparsec parsers (instead of regex)

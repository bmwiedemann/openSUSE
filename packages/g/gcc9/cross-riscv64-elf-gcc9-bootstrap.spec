#
# spec file for package cross-riscv64-elf-gcc9-bootstrap
#
...
%define pkgname cross-riscv64-elf-gcc9-bootstrap
...
Conflicts:      cross-%{cross_arch}-gcc9
%endif
#!BuildIgnore: gcc-PIE
...
%package -n cross-%cross_arch-gcc9-icecream-backend
Summary:        Icecream backend for the GNU C Compiler
Group:          Development/Languages/C and C++

%description -n cross-%cross_arch-gcc9-icecream-backend
This package contains the icecream environment for the GNU C Compiler
%endif

%if 0%{?nvptx_newlib:1}
%package -n cross-nvptx-newlib9-devel
...
%description -n cross-nvptx-newlib9-devel
...
%{_sbindir}/update-alternatives \
  --install %{_bindir}/%{gcc_target_arch}-gcc %{gcc_target_arch}-gcc %{_bindir}/%{gcc_target_arch}-gcc%{binsuffix} 9 \
...
%if 0%{?gcc_icecream:%gcc_icecream}
%files -n cross-%cross_arch-gcc9-icecream-backend
%defattr(-,root,root)
/usr/share/icecream-envs
%endif

%if 0%{?nvptx_newlib:1}
%files -n cross-nvptx-newlib9-devel
%defattr(-,root,root)

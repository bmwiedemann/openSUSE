...
%global pkg_name text-builder-dev
...
%description
This is a development version of "text-builder". All experimentation and
feature development happens here. The API can change drastically. For a more
stable API use "text-builder", which is now just a wrapper over this package.

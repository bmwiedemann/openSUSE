...
Patch:          info-dir-entry.patch
Patch:          grub2-sysfb.patch
Patch:          grub2-iterate-and-hook-for-extended-partition.patch
Patch:          grub2-ppc-terminfo.patch
Patch:          grub2-fix-error-terminal-gfxterm-isn-t-found.patch
Patch:          grub2-fix-menu-in-xen-host-server.patch
Patch:          not-display-menu-when-boot-once.patch
Patch:          grub2-pass-corret-root-for-nfsroot.patch
Patch:          grub2-efi-HP-workaround.patch
Patch:          grub2-secureboot-add-linuxefi.patch
Patch:          grub2-secureboot-no-insmod-on-sb.patch
Patch:          grub2-secureboot-chainloader.patch
Patch:          grub2-linuxefi-fix-boot-params.patch
Patch:          grub2-linguas.sh-no-rsync.patch
Patch:          grub2-use-Unifont-for-starfield-theme-terminal.patch
Patch:          grub2-s390x-01-Changes-made-and-files-added-in-order-to-allow-s390x.patch
Patch:          grub2-s390x-03-output-7-bit-ascii.patch
Patch:          grub2-s390x-04-grub2-install.patch
Patch:          grub2-s390x-05-grub2-mkconfig.patch
Patch:          grub2-use-rpmsort-for-version-sorting.patch
Patch:          grub2-setup-try-fs-embed-if-mbr-gap-too-small.patch
Patch:          grub2-xen-linux16.patch
Patch:          grub2-efi-disable-video-cirrus-and-bochus.patch
Patch:          grub2-vbe-blacklist-preferred-1440x900x32.patch
Patch:          grub2-mkconfig-aarch64.patch
Patch:          grub2-default-distributor.patch
Patch:          grub2-menu-unrestricted.patch
Patch:          grub2-mkconfig-arm.patch
Patch:          grub2-s390x-06-loadparm.patch
Patch:          grub2-s390x-07-add-image-param-for-zipl-setup.patch
Patch:          grub2-s390x-08-workaround-part-to-disk.patch
Patch:          grub2-commands-introduce-read_file-subcommand.patch
Patch:          grub2-efi-chainload-harder.patch
Patch:          grub2-emu-4-all.patch
Patch:          grub2-lvm-allocate-metadata-buffer-from-raw-contents.patch
Patch:          grub2-diskfilter-support-pv-without-metadatacopies.patch
Patch:          grub2-s390x-09-improve-zipl-setup.patch
Patch:          grub2-getroot-scan-disk-pv.patch
Patch:          grub2-util-30_os-prober-multiple-initrd.patch
Patch:          grub2-getroot-support-nvdimm.patch
Patch:          grub2-install-fix-not-a-directory-error.patch
Patch:          grub-install-force-journal-draining-to-ensure-data-i.patch
Patch:          grub2-s390x-skip-zfcpdump-image.patch
Patch:          grub2-btrfs-01-add-ability-to-boot-from-subvolumes.patch
Patch:          grub2-btrfs-02-export-subvolume-envvars.patch
Patch:          grub2-btrfs-03-follow_default.patch
Patch:          grub2-btrfs-04-grub2-install.patch
Patch:          grub2-btrfs-05-grub2-mkconfig.patch
...
Patch:          grub2-efi-xen-cfg-unquote.patch
Patch:          grub2-efi-xen-removable.patch
Patch:          grub2-Add-hidden-menu-entries.patch
Patch:          grub2-SUSE-Add-the-t-hotkey.patch
Patch:          grub2-zipl-setup-fix-btrfs-multipledev.patch
Patch:          grub2-suse-remove-linux-root-param.patch
Patch:          grub2-ppc64le-disable-video.patch
Patch:          grub2-ppc64le-memory-map.patch
Patch:          grub2-ppc64-cas-reboot-support.patch
Patch:          grub2-install-remove-useless-check-PReP-partition-is-empty.patch
Patch:          grub2-ppc64-cas-new-scope.patch
Patch:          grub2-ppc64-cas-fix-double-free.patch
Patch:          grub2-efi_gop-avoid-low-resolution.patch
Patch:          0003-bootp-New-net_bootp6-command.patch
Patch:          0004-efinet-UEFI-IPv6-PXE-support.patch
Patch:          0005-grub.texi-Add-net_bootp6-doument.patch
Patch:          0006-bootp-Add-processing-DHCPACK-packet-from-HTTP-Boot.patch
Patch:          0007-efinet-Setting-network-from-UEFI-device-path.patch
Patch:          0008-efinet-Setting-DNS-server-from-UEFI-protocol.patch
Patch:          0012-tpm-Build-tpm-as-module.patch
Patch:          0001-add-support-for-UEFI-network-protocols.patch
Patch:          0002-AUDIT-0-http-boot-tracker-bug.patch
Patch:          grub2-mkconfig-default-entry-correction.patch
Patch:          grub2-s390x-11-secureboot.patch
Patch:          grub2-s390x-12-zipl-setup-usrmerge.patch
Patch:          grub2-secureboot-install-signed-grub.patch
Patch:          grub2-btrfs-help-on-snapper-rollback.patch
Patch:          grub2-video-limit-the-resolution-for-fixed-bimap-font.patch
Patch:          grub2-gfxmenu-support-scrolling-menu-entry-s-text.patch
Patch:          0001-kern-mm.c-Make-grub_calloc-inline.patch
Patch:          0002-cmdline-Provide-cmdline-functions-as-module.patch
Patch:          0001-ieee1275-powerpc-implements-fibre-channel-discovery-.patch
Patch:          0002-ieee1275-powerpc-enables-device-mapper-discovery.patch
Patch:          0001-Unify-the-check-to-enable-btrfs-relative-path.patch
Patch:          0001-efi-linux-provide-linux-command.patch
Patch:          0001-Add-support-for-Linux-EFI-stub-loading-on-aarch64.patch
Patch:          0002-arm64-make-sure-fdt-has-address-cells-and-size-cells.patch
Patch:          0004-arm-arm64-loader-Better-memory-allocation-and-error-.patch
Patch:          0006-efi-Set-image-base-address-before-jumping-to-the-PE-.patch
Patch:          0044-squash-kern-Add-lockdown-support.patch
Patch:          0001-ieee1275-Avoiding-many-unecessary-open-close.patch
Patch:          0001-Workaround-volatile-efi-boot-variable.patch
Patch:          0001-templates-Follow-the-path-of-usr-merged-kernel-confi.patch
Patch:          0001-ieee1275-implement-FCP-methods-for-WWPN-and-LUNs.patch
Patch:          0001-arm64-Fix-EFI-loader-kernel-image-allocation.patch
Patch:          0002-Arm-check-for-the-PE-magic-for-the-compiled-arch.patch
Patch:          0001-Factor-out-grub_efi_linux_boot.patch
Patch:          0002-Fix-race-in-EFI-validation.patch
Patch:          0003-Handle-multi-arch-64-on-32-boot-in-linuxefi-loader.patch
Patch:          0004-Try-to-pick-better-locations-for-kernel-and-initrd.patch
Patch:          0005-x86-efi-Use-bounce-buffers-for-reading-to-addresses-.patch
Patch:          0006-x86-efi-Re-arrange-grub_cmd_linux-a-little-bit.patch
Patch:          0007-x86-efi-Make-our-own-allocator-for-kernel-stuff.patch
Patch:          0008-x86-efi-Allow-initrd-params-cmdline-allocations-abov.patch
Patch:          0009-x86-efi-Reduce-maximum-bounce-buffer-size-to-16-MiB.patch
Patch:          0010-efilinux-Fix-integer-overflows-in-grub_cmd_initrd.patch
Patch:          0011-Also-define-GRUB_EFI_MAX_ALLOCATION_ADDRESS-for-RISC.patch
Patch:          0001-grub-install-Add-SUSE-signed-image-support-for-power.patch
Patch:          0001-Add-grub_envblk_buf-helper-function.patch
Patch:          0002-Add-grub_disk_write_tail-helper-function.patch
Patch:          0003-grub-install-support-prep-environment-block.patch
Patch:          0004-Introduce-prep_load_env-command.patch
Patch:          0005-export-environment-at-start-up.patch
Patch:          0001-grub-install-bailout-root-device-probing.patch
Patch:          0001-install-fix-software-raid1-on-esp.patch
Patch:          0001-grub-probe-Deduplicate-probed-partmap-output.patch
Patch:          0001-Fix-infinite-boot-loop-on-headless-system-in-qemu.patch
Patch:          0001-ofdisk-improve-boot-time-by-lookup-boot-disk-first.patch
Patch:          0008-linuxefi-Use-common-grub_initrd_load.patch
Patch:          0009-Add-crypttab_entry-to-obviate-the-need-to-input-pass.patch
Patch:          0010-templates-import-etc-crypttab-to-grub.cfg.patch
Patch:          grub-read-pcr.patch
Patch:          tpm-record-pcrs.patch
Patch:          grub-install-record-pcrs.patch
Patch:          safe_tpm_pcr_snapshot.patch
Patch:          0001-ieee1275-add-support-for-NVMeoFC.patch
Patch:          0002-ieee1275-ofpath-enable-NVMeoF-logical-device-transla.patch
Patch:          0003-ieee1275-change-the-logic-of-ieee1275_get_devargs.patch
Patch:          grub2-increase-crypttab-path-buffer.patch
Patch:          0001-tpm2-Add-extra-RSA-SRK-types.patch
Patch:          0001-clean-up-crypttab-and-linux-modules-dependency.patch
Patch:          0002-discard-cached-key-before-entering-grub-shell-and-ed.patch
Patch:          0001-ieee1275-ofdisk-retry-on-open-and-read-failure.patch
Patch:          0002-Restrict-cryptsetup-key-file-permission-for-better-s.patch
Patch:          0001-openfw-Ensure-get_devargs-and-get_devname-functions-.patch
Patch:          0002-prep_loadenv-Fix-regex-for-Open-Firmware-device-spec.patch
Patch:          0001-font-Try-memdisk-fonts-with-the-same-name.patch
Patch:          0001-Make-grub.cfg-compatible-to-old-binaries.patch
Patch:          grub2-mkconfig-riscv64.patch
Patch:          arm64-Use-proper-memory-type-for-kernel-allocation.patch
Patch:          0001-luks2-Use-grub-tpm2-token-for-TPM2-protected-volume-.patch
Patch:          Fix-the-size-calculation-for-the-synthesized-initrd.patch
Patch:          0001-loader-arm64-efi-linux-Remove-magic-number-header-fi.patch
Patch:          0001-ofdisk-enhance-boot-time-by-focusing-on-boot-disk-re.patch
Patch:          0002-ofdisk-add-early_log-support.patch
Patch:          0001-disk-Optimize-disk-iteration-by-moving-memdisk-to-th.patch
Patch:          grub2-bsc1220338-key_protector-implement-the-blocklist.patch
Patch:          0001-ofdisk-Enhance-canonical-path-handling-for-bootpath.patch
Patch:          0001-10_linux-Ensure-persistence-of-root-file-system-moun.patch
Patch:          0001-util-enable-grub-protect-only-for-EFI-systems.patch
Patch:          grub2-s390x-set-hostonly.patch
Patch:          0001-Streamline-BLS-and-improve-PCR-stability.patch
Patch:          0001-ieee1275-support-added-for-multiple-nvme-bootpaths.patch
Patch:          0001-kern-main-Fix-cmdpath-in-root-directory.patch
Patch:          grub2-s390x-secure-execution-support.patch
Patch:          0001-autofs-Ignore-zfs-not-found.patch
Patch:          0001-s390x-emu-Pass-through-PAES-cipher-as-AES.patch
Patch:          0001-ofpath-Add-error-check-in-NVMEoF-device-translation.patch
Patch:          grub2-btrfs-filter-non-subvol-mount.patch
Patch:          0001-prep_loadenv-Measure-the-environment-block-into-PCR-.patch
Patch:          0001-Fix-PowerPC-CAS-reboot-to-evaluate-menu-context.patch
Patch:          0001-blscfg-read-fragments-in-order.patch
Patch:          grub2-bls-boot-show-snapshot.patch
...
Patch:          0003-efi-chainloader-fallback-to-direct-image-execution.patch
Patch:          0004-efi-chainloader-fix-missing-file_path-in-loaded_imag.patch
Patch:          grub2-i386-pc-no-pageflipping.patch
Patch:          0001-editenv-create-health_check_flag-env-var-on-RW-raw-b.patch
Patch:          0001-00_header-Omit-loading-efi_uga-on-non-x86-EFI-platfo.patch
Patch:          0001-Revert-configure-Print-a-more-helpful-error-if-autoc.patch
Patch:          0002-Revert-configure-Check-linker-for-image-base-support.patch
Patch:          0001-blsuki-Fix-linux_cmd-size-calcution-in-bls_get_linux.patch
Patch:          0001-bls-Allow-configuration-of-active-console-type.patch
Patch:          0002-grubbls-Add-automatic-fwsetup-menu-entry.patch
Patch:          0001-ieee1275-support-dm-multipath-bootlist.patch
Patch:          0001-mdraid1x-fix-raid_disks-decoding-on-big-endian-syste.patch
Patch:          0001-blsuki-Add-support-for-LoaderEntries.patch
Patch:          0002-menu-Allow-default-entry-to-have-.conf-suffix.patch
Patch:          0003-bli-Add-support-for-LoaderEntryDefault-and-LoaderEnt.patch
Patch:          0004-bli-Add-support-for-LoaderConfigTimeout-and-LoaderCo.patch
Patch:          0005-bls_bumpcounter-Add-command-to-bump-boot-counter-for.patch
Patch:          0006-bli-Add-support-for-LoaderFeatures.patch
Patch:          0007-blsuki-Fix-sorting-for-entries-with-boot-counting-en.patch
Patch:          0008-blsuki-append-leftover-LoaderEntries.patch
Patch:          0009-blsuki-conservative-UTF-8-buffer-size.patch
Patch:          0001-Mandatory-install-device-check-for-PowerPC.patch
Patch:          0001-osdep-linux-ofpath-Update-strstr-calls.patch
Patch:          0001-util-probe-Save-strrchr-ret-val-to-const-data-ptr.patch
Patch:          0002-util-resolve-Save-str-r-chr-ret-val-to-const-data-pt.patch
Patch:          0001-Fix-problematic-utf8-conversion-in-bli-patches.patch

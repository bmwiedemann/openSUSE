...
Source:         https://files.pythonhosted.org/packages/source/g/gi_docgen/gi_docgen-%{version}.tar.gz
...
Provides:       python3-gi-docgen = %{version}
Obsoletes:      python3-gi-docgen < %{version}
BuildArch:      noarch
...
%{python3_sitelib}/gi_docgen-%{version}*-info/

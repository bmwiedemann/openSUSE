#
# spec file for package ghc-skylighting-format-ansi
#
...
%global pkg_name skylighting-format-ansi
%global pkgver %{pkg_name}-%{version}
Name:           ghc-%{pkg_name}
Version:        0.1
Release:        0
Summary:        ANSI formatter for skylighting syntax highlighting library

...
%package -n gcc10-32bit
Summary:        The GNU C Compiler 32bit support
License:        GPL-3.0-or-later
Group:          Development/Languages/C and C++
Requires:       gcc10 = %{version}-%{release}
...
Group:          Development/Languages/C and C++
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-c++ = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/C and C++
Requires:       gcc10-32bit = %{version}-%{release}
Requires:       gcc10-c++ = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/C and C++
Requires:       gcc10-64bit = %{version}-%{release}
Requires:       gcc10-c++ = %{version}-%{release}
...
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-objc = %{version}-%{release}
...
Group:          Development/Languages/Other
Requires:       gcc10-c++ = %{version}-%{release}
Requires:       gcc10-obj-c++ = %{version}-%{release}
Requires:       gcc10-objc = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc10-c++-32bit = %{version}-%{release}
Requires:       gcc10-obj-c++ = %{version}-%{release}
Requires:       gcc10-objc-32bit = %{version}-%{release}
...
License:        GPL-3.0-or-later
Group:          Development/Languages/Other
Requires:       gcc10-c++-64bit = %{version}-%{release}
Requires:       gcc10-obj-c++ = %{version}-%{release}
Requires:       gcc10-objc-64bit = %{version}-%{release}
...
Group:          Development/Languages/Other
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-ada = %{version}-%{release}
Requires:       libada10 = %{version}-%{release}
...
Requires:       gcc10-32bit = %{version}-%{release}
Requires:       gcc10-ada = %{version}-%{release}
Requires:       libada10-32bit = %{version}-%{release}
...
Requires:       gcc10-64bit = %{version}-%{release}
Requires:       gcc10-ada = %{version}-%{release}
Requires:       libada10-64bit = %{version}-%{release}
...
Provides:       libgnat-10 = %{version}-%{release}
Conflicts:      %selfconflict libgnat-10

%description -n libada10
...
%post -n libada10 -p /sbin/ldconfig
...
Provides:       libgnat-10-32bit = %{version}-%{release}
Conflicts:      %selfconflict libgnat-10-32bit

%description -n libada10-32bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada10-32bit -p /sbin/ldconfig
...
Provides:       libgnat-10-64bit = %{version}-%{release}
Conflicts:      %selfconflict libgnat-10-64bit

%description -n libada10-64bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada10-64bit -p /sbin/ldconfig

%postun -n libada10-64bit -p /sbin/ldconfig
...
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-fortran = %{version}-%{release}
...
Group:          Development/Languages/Other
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-go = %{version}-%{release}
...
Group:          Development/Languages/Other
Requires:       gcc10 = %{version}-%{release}
Requires:       gcc10-d = %{version}-%{release}
...
%package -n gcc10-testresults
Summary:        Testsuite results
License:        SUSE-Public-Domain
Group:          Development/Languages/C and C++

%description -n gcc10-testresults
...
%find_lang libstdc++
cat cpplib%{binsuffix}.lang gcc%{binsuffix}.lang > gcc10-locale.lang
...
%if %{separate_biarch}
%files -n gcc10%{separate_biarch_suffix}
%defattr(-,root,root)
%versbiarchlib *crt*.o
...
%files locale -f gcc10-locale.lang
...
%if %{separate_biarch}
%files -n libada10%{separate_biarch_suffix}
%defattr(-,root,root)

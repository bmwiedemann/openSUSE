...
Requires:       gap-primgrp >= 4.0.2
Requires:       gap-smallgrp >= 1.5.4
Requires:       gap-transgrp >= 3.6.5
# API incompatibility
Conflicts:      gap-polycyclic < 2.17

%define lname libgap11
...
Requires:       gap-4ti2interface >= 2026.05.01
Requires:       gap-ace >= 5.7.0
Requires:       gap-aclib >= 1.3.3
Requires:       gap-agt >= 0.3.1
Requires:       gap-alco >= 1.1.2
Requires:       gap-alnuth >= 4.0.0
Requires:       gap-anupq >= 3.3.3
Requires:       gap-atlasrep >= 2.1.11
Requires:       gap-autodoc >= 2026.05.11
Requires:       gap-automata >= 1.16
Requires:       gap-automgrp >= 1.3.3
Requires:       gap-autpgrp >= 1.12.0
Requires:       gap-browse >= 1.8.22
Requires:       gap-cap >= 2026.05.08
Requires:       gap-caratinterface >= 2.3.9
Requires:       gap-cddinterface >= 2026.03.02
Requires:       gap-circle >= 1.6.6
Requires:       gap-classicalmaximals >= 1.1
...
Requires:       gap-cryst >= 4.1.31
Requires:       gap-crystcat >= 1.1.10
Requires:       gap-ctbllib >= 1.3.11
Requires:       gap-cubefree >= 1.21
Requires:       gap-curlinterface >= 2.4.3
Requires:       gap-cvec >= 2.8.5
Requires:       gap-datastructures >= 0.4.1
Requires:       gap-deepthought >= 1.0.9
Requires:       gap-design >= 1.8.2
Requires:       gap-difsets >= 2.3.1
Requires:       gap-digraphs >= 1.14.0
Requires:       gap-edim >= 1.3.8
Requires:       gap-example >= 4.4.1
Requires:       gap-examplesforhomalg >= 2025.12.01
Requires:       gap-factint >= 1.6.3
Requires:       gap-ferret >= 1.0.16
Requires:       gap-fga >= 1.5.0
Requires:       gap-fining >= 1.5.6
Requires:       gap-float >= 1.0.10
Requires:       gap-format >= 1.4.5
Requires:       gap-forms >= 1.3.0
Requires:       gap-fplsa >= 1.2.8
Requires:       gap-fr >= 2.4.13
#dependson jupyterkernel#Requires:       gap-francy >= 2.0.3
Requires:       gap-fwtree >= 1.3
Requires:       gap-gapdoc >= 1.6.10
Requires:       gap-gauss >= 2025.12.01
Requires:       gap-gaussforhomalg >= 2026.04.01
Requires:       gap-gbnp >= 1.1.0
Requires:       gap-generalizedmorphismsforcap >= 2025.12.01
Requires:       gap-genss >= 1.6.9
Requires:       gap-gradedmodules >= 2026.04.01
Requires:       gap-gradedringforhomalg >= 2026.04.01
Requires:       gap-grape >= 4.9.3
Requires:       gap-groupoids >= 1.81
Requires:       gap-grpconst >= 2.6.5
Requires:       gap-guarana >= 0.96.3
Requires:       gap-guava >= 3.21
Requires:       gap-hap >= 1.75
Requires:       gap-hapcryst >= 0.2.0
Requires:       gap-hecke >= 1.5.4
Requires:       gap-help >= 4.1
Requires:       gap-homalg >= 2025.12.01
Requires:       gap-homalgtocas >= 2026.04.01
Requires:       gap-ibnp >= 0.18
...
Requires:       gap-io_forhomalg >= 2025.12.01
Requires:       gap-irredsol >= 1.4.4
Requires:       gap-itc >= 1.5.1
Requires:       gap-json >= 2.4.0

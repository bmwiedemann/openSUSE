...
# rust now requires cargo to build, disable it everywhere
...
%if %{build_ada}
%if 0%{?gcc_version:%{gcc_version}} > 15
...
%endif
%if %{build_nvptx}
BuildRequires:  cross-nvptx-gcc15
BuildRequires:  cross-nvptx-newlib15-devel
%endif
%if %{build_gcn}
BuildRequires:  cross-amdgcn-gcc15
BuildRequires:  cross-amdgcn-newlib15-devel
%endif
%endif
%if %{build_rust}
# FIXME

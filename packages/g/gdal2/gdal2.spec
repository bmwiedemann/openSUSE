...
Source0:        http://download.osgeo.org/%{mainname}/%{version}/%{sourcename}-%{version}.tar.xz
Source1:        http://download.osgeo.org/%{mainname}/%{version}/%{sourcename}-%{version}.tar.xz.md5

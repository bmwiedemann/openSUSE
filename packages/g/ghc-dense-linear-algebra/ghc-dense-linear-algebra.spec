#
# spec file for package ghc-dense-linear-algebra
#
...
%global pkg_name dense-linear-algebra
%bcond_with tests
Name:           ghc-%{pkg_name}
Version:        0.1.0.0
Release:        0
...
%description
This library is simply collection of linear-algebra related modules split from
statistics library.

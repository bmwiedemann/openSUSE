...
Obsoletes:      granatier5 < %{version}
Provides:       granatier5 = %{version}
...
%files
%license LICENSES/*
%doc %lang(en) %{_kf6_htmldir}/en/granatier/
%{_kf6_applicationsdir}/org.kde.granatier.desktop
%{_kf6_appstreamdir}/org.kde.granatier.appdata.xml
...
%exclude %{_kf6_htmldir}/en/granatier/

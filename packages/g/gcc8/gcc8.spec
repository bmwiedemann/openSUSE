...
%define itsme8 1
%define plv_ %{!?product_libs_gcc_ver:8}%{?product_libs_gcc_ver}
%define plv() %{expand:%%{!?itsme%{expand:%%{!?product_libs_gcc_ver_%{1}%{2}:%%{plv_}}%%{?product_libs_gcc_ver_%{1}%{2}}}:-gcc8}}
...
%endif
%if %{build_ada}
%if 0%{?gcc_version:%{gcc_version}} > 8
%define hostsuffix %{binsuffix}
BuildRequires:  gcc8-ada
...
%endif
Suggests:       gcc8-info gcc8-locale
%endif
...
Requires:       gcc8-obj-c++ = %{version}-%{release}
Requires:       gcc8-objc-32bit = %{version}-%{release}
...
Requires:       gcc8-obj-c++ = %{version}-%{release}
Requires:       gcc8-objc-64bit = %{version}-%{release}
...
Requires:       libada8 = %{version}-%{release}
...
Requires:       gcc8-32bit = %{version}-%{release}
Requires:       gcc8-ada = %{version}-%{release}
Requires:       libada8-32bit = %{version}-%{release}
...
Requires:       gcc8-64bit = %{version}-%{release}
Requires:       gcc8-ada = %{version}-%{release}
Requires:       libada8-64bit = %{version}-%{release}
...
License:        GPL-3.0-with-GCC-exception
Group:          System/Libraries
Provides:       libgnarl-8 = %{version}-%{release}
Conflicts:      %selfconflict libgnarl-8
Provides:       libgnat-8 = %{version}-%{release}
Conflicts:      %selfconflict libgnat-8

%description -n libada8
...
%post -n libada8 -p /sbin/ldconfig

%postun -n libada8 -p /sbin/ldconfig
%package -n libada8-32bit
Summary:        GNU Ada Runtime Libraries
License:        GPL-3.0-with-GCC-exception
Group:          System/Libraries
Provides:       libgnarl-8-32bit = %{version}-%{release}
Conflicts:      %selfconflict libgnarl-8-32bit
Provides:       libgnat-8-32bit = %{version}-%{release}
Conflicts:      %selfconflict libgnat-8-32bit

%description -n libada8-32bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada8-32bit -p /sbin/ldconfig

%postun -n libada8-32bit -p /sbin/ldconfig
%package -n libada8-64bit
Summary:        GNU Ada Runtime Libraries
License:        GPL-3.0-with-GCC-exception
Group:          System/Libraries
Provides:       libgnarl-8-64bit = %{version}-%{release}
Conflicts:      %selfconflict libgnarl-8-64bit
Provides:       libgnat-8-64bit = %{version}-%{release}
Conflicts:      %selfconflict libgnat-8-64bit

%description -n libada8-64bit
This package contains the shared libraries required to run programs
compiled with the GNU Ada compiler (GNAT) if they are compiled to use
shared libraries. It also contains the shared libraries for the
Implementation of the Ada Semantic Interface Specification (ASIS), the
...
%post -n libada8-64bit -p /sbin/ldconfig

%postun -n libada8-64bit -p /sbin/ldconfig
...
%package -n gcc8-testresults
Summary:        Testsuite results
License:        SUSE-Public-Domain
Group:          Development/Languages/C and C++

%description -n gcc8-testresults
...
%find_lang libstdc++
cat cpplib%{binsuffix}.lang gcc%{binsuffix}.lang > gcc8-locale.lang
...
%if %{separate_biarch}
%files -n gcc8%{separate_biarch_suffix}
%defattr(-,root,root)
%versbiarchlib *crt*.o
...
%files locale -f gcc8-locale.lang
...
%if %{separate_biarch}
%files -n libada8%{separate_biarch_suffix}
%defattr(-,root,root)

#
# spec file for package cross-avr-gcc8-bootstrap
#
...
%define pkgname cross-avr-gcc8-bootstrap
...
Conflicts:      cross-%{cross_arch}-gcc8
%endif
#!BuildIgnore: gcc-PIE
...
Source1:        change_spec
Source2:        gcc8-rpmlintrc
Source3:        gcc8-testresults-rpmlintrc
...
%package -n cross-%cross_arch-gcc8-icecream-backend
Summary:        Icecream backend for the GNU C Compiler
Group:          Development/Languages/C and C++

%description -n cross-%cross_arch-gcc8-icecream-backend
This package contains the icecream environment for the GNU C Compiler
%endif

%if 0%{?nvptx_newlib:1}
%package -n cross-nvptx-newlib8-devel
...
%description -n cross-nvptx-newlib8-devel
...
%{_sbindir}/update-alternatives \
  --install %{_bindir}/%{gcc_target_arch}-gcc %{gcc_target_arch}-gcc %{_bindir}/%{gcc_target_arch}-gcc%{binsuffix} 8 \
...
%if 0%{?gcc_icecream:%gcc_icecream}
%files -n cross-%cross_arch-gcc8-icecream-backend
%defattr(-,root,root)
/usr/share/icecream-envs
%endif

%if 0%{?nvptx_newlib:1}
%files -n cross-nvptx-newlib8-devel
%defattr(-,root,root)

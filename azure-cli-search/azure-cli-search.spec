...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-search/azure-cli-search-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-search-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-search-%{version}

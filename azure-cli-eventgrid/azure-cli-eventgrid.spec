...
Source:         https://files.pythonhosted.org/packages/source/a/azure-cli-eventgrid/azure-cli-eventgrid-%{version}.tar.gz
Source1:        LICENSE.txt
...
%prep
%setup -q -n azure-cli-eventgrid-%{version}

%build
install -m 644 %{SOURCE1} %{_builddir}/azure-cli-eventgrid-%{version}

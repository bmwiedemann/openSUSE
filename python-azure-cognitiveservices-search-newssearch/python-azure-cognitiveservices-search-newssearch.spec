...
Source1:        LICENSE.txt
Patch1:         acsn_drop-compatible-releases-operator.patch
...
%description
This is the Microsoft Azure NewsSearch Client Library.
...
%{python_sitelib}/azure_cognitiveservices_search_newssearch-*.egg-info
